...
(
    ...
    CELESTIEL_ARCANA,
    BRYNTHEA_ARCANA,
    CRYSTAL_OF_PROGRESS1,
    CRYSTAL_OF_INPROGRESS1,
    CRYSTAL_OF_FOUL1,
    CRYSTAL_OF_DEFEAT1,
    CRYSTAL_OF_VICTORY1,
    CRYSTAL_OF_PROGRESS2,
    CRYSTAL_OF_INPROGRESS2,
    CRYSTAL_OF_FOUL2,
    CRYSTAL_OF_DEFEAT2,
    CRYSTAL_OF_VICTORY2,
    CRYSTAL_OF_PROGRESS3,
    CRYSTAL_OF_INPROGRESS3,
    CRYSTAL_OF_FOUL3,
    CRYSTAL_OF_DEFEAT3,
    CRYSTAL_OF_VICTORY3,
    CRYSTAL_OF_PROGRESS4,
    CRYSTAL_OF_INPROGRESS4,
    CRYSTAL_OF_FOUL4,
    CRYSTAL_OF_DEFEAT4,
    CRYSTAL_OF_VICTORY4,
    CRYSTAL_OF_PROGRESS5,
    CRYSTAL_OF_INPROGRESS5,
    CRYSTAL_OF_FOUL5,
    CRYSTAL_OF_DEFEAT5,
    CRYSTAL_OF_VICTORY5,
    CRYSTAL_OF_PROGRESS6,
    CRYSTAL_OF_INPROGRESS6,
    CRYSTAL_OF_FOUL6,
    CRYSTAL_OF_DEFEAT6,
    CRYSTAL_OF_VICTORY6,
) = range(3337, 3390)
...
class Quest(JQuest):
    ...
    def onTalk(self, npc, player):
        ...
        npcId = npc.getNpcId()
        id = st.getState()
        if npcId != NPC[1] and id != PROGRESS:
            return htmltext
        ...
        if id == CREATED and npcId == Galatea:  # start part, Galatea
            ...
            step = st.getInt(
                "step"
            )  # stats as short vars if the player has state <Progress>
            ...
            if npcId == Galatea:  # Start and End Npc Galatea related stuff
                ...
                if step > 1:
                    if (
                        SummonerStat == 1
                    ):  # default, just able to start talk with the summoner
                        ...
                        st.set(
                            SUMMONERS[npcId][0], "7"
                        )  # set 7, this mark that the players' summon won the battle
                        st.set(
                            "Arcanas", str(Arcanas + 1)
                        )  # set arcana stat +1, if its 6... quest is finished and he can earn the mark
                    elif (
                        SummonerStat == 7
            ...
            if self.inProgressDuelMobs.has_key(npcId):
                ...
                if not self.inProgressDuelMobs[npcId][2]:
                    ...
                    if st.getInt(var) == 3:
                        ...
                        st.giveItems(
                            victory, 1
                        )  # if he wons without cheating, set stat won and give victory crystal
                        st.playSound("Itemsound.quest_middle")
