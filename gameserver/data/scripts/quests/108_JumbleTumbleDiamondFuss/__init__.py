...
class Quest(JQuest):
    ...
    def onTalk(self, npc, player):
        ...
        if npcId == 30523 and id == COMPLETED:
            ...
            and st.getQuestItemsCount(GOUPHS_CONTRACT_ID)
        ):
            ...
            and st.getInt("cond") == 1
            and (
                st.getQuestItemsCount(REEPS_CONTRACT_ID)
                or st.getQuestItemsCount(ELVEN_WINE_ID)
                or st.getQuestItemsCount(BRONPS_DICE_ID)
                or st.getQuestItemsCount(BRONPS_CONTRACT_ID)
            )
        ):
            ...
            npcId == 30523
            and st.getInt("cond") == 1
            and st.getQuestItemsCount(GEM_BOX1_ID)
        ):
            ...
            and st.getInt("cond") == 1
            and (
                st.getQuestItemsCount(BRONPS_LETTER_ID)
                or st.getQuestItemsCount(COAL_PIECE_ID)
                or st.getQuestItemsCount(BERRY_TART_ID)
                or st.getQuestItemsCount(BAT_DIAGRAM_ID)
            )
        ):
            ...
            npcId == 30523
            and st.getInt("cond") == 1
            and st.getQuestItemsCount(STAR_DIAMOND_ID)
        ):
            htmltext = "30523-08.htm"
            if (
                player.getLevel() < 25
                and st.getInt("onlyone") == 0
                and player.isNewbie()
            ):
            ...
            st.giveItems(
                1060, int(100 * Config.RATE_QUESTS_REWARD)
            ...
            if (
                ...
                and st.getInt("cond") == 1
                and st.getQuestItemsCount(GOUPHS_CONTRACT_ID)
                and st.getQuestItemsCount(REEPS_CONTRACT_ID) == 0
            ):
                ...
                npcId == 30516
                and st.getInt("cond") == 1
                and st.getQuestItemsCount(GOUPHS_CONTRACT_ID) == 0
                and st.getQuestItemsCount(REEPS_CONTRACT_ID)
            ):
                ...
                and st.getInt("cond") == 1
                and st.getQuestItemsCount(REEPS_CONTRACT_ID) == 0
                and st.getQuestItemsCount(ELVEN_WINE_ID) == 0
            ):
                ...
                and st.getInt("cond") == 1
                and st.getQuestItemsCount(REEPS_CONTRACT_ID) == 0
                and st.getQuestItemsCount(ELVEN_WINE_ID)
            ):
                htmltext = "30555-03.htm"
            elif (
                npcId == 30555
                and st.getInt("cond") == 1
                and st.getQuestItemsCount(GEM_BOX1_ID) == 1
            ):
                htmltext = "30555-04.htm"
            elif (
                npcId == 30555
                and st.getInt("cond") == 1
                and st.getQuestItemsCount(GEM_BOX1_ID) == 0
                and st.getQuestItemsCount(REEPS_CONTRACT_ID) == 0
                and st.getQuestItemsCount(ELVEN_WINE_ID) == 0
            ):
                ...
                and st.getInt("cond") == 1
                and st.getQuestItemsCount(ELVEN_WINE_ID)
                and st.getQuestItemsCount(BRONPS_DICE_ID) == 0
            ):
                ...
                and st.getInt("cond") == 1
                and st.getQuestItemsCount(ELVEN_WINE_ID) == 0
                and st.getQuestItemsCount(BRONPS_DICE_ID)
            ):
                ...
                npcId == 30526
                and st.getInt("cond") == 1
                and st.getQuestItemsCount(BRONPS_CONTRACT_ID)
                and (
                    st.getQuestItemsCount(AQUAMARINE_ID)
                    + st.getQuestItemsCount(CHRYSOBERYL_ID)
                    < 20
                )
            ):
                ...
                npcId == 30526
                and st.getInt("cond") == 1
                and st.getQuestItemsCount(COAL_PIECE_ID)
            ):
                ...
                npcId == 30526
                and st.getInt("cond") == 1
                and st.getQuestItemsCount(BRONPS_LETTER_ID)
            ):
                htmltext = "30526-07.htm"
            elif (
                npcId == 30526
                and st.getInt("cond") == 1
                and st.getQuestItemsCount(BERRY_TART_ID)
                or st.getQuestItemsCount(BAT_DIAGRAM_ID)
                or st.getQuestItemsCount(STAR_DIAMOND_ID)
            ):
                ...
                and st.getInt("cond") == 1
                and st.getQuestItemsCount(BRONPS_LETTER_ID)
                and st.getQuestItemsCount(BERRY_TART_ID) == 0
            ):
                ...
                npcId == 30521
                and st.getInt("cond") == 1
                and st.getQuestItemsCount(BRONPS_LETTER_ID) == 0
                and st.getQuestItemsCount(BERRY_TART_ID)
            ):
                ...
                npcId == 30522
                and st.getInt("cond") == 1
                and st.getQuestItemsCount(BAT_DIAGRAM_ID) == 0
                and st.getQuestItemsCount(BERRY_TART_ID)
                and st.getQuestItemsCount(STAR_DIAMOND_ID) == 0
            ):
                ...
                npcId == 30522
                and st.getInt("cond") == 1
                and st.getQuestItemsCount(BAT_DIAGRAM_ID)
                and st.getQuestItemsCount(BERRY_TART_ID) == 0
                and st.getQuestItemsCount(STAR_DIAMOND_ID) == 0
            ):
