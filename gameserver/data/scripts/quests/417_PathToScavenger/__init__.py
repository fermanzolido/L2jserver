...
class Quest(JQuest):
    ...
    def onEvent(self, event, st):
        ...
        if event == "1":
            ...
            if (
                level >= 19
                and classId == 0x35
                and st.getQuestItemsCount(RING_OF_RAVEN) == 0
            ):
                st.set("cond", "1")
                st.setState(STARTED)
                ...
                level >= 19
                and classId == 0x35
                and st.getQuestItemsCount(RING_OF_RAVEN) == 1
            ):
            ...
            if (
                ...
                or st.getQuestItemsCount(CHALIS_AXE)
                or st.getQuestItemsCount(BRONKS_INGOT)
            ):
            ...
            if (
                ...
                or st.getQuestItemsCount(CHALIS_PAY)
                or st.getQuestItemsCount(BRONKS_PAY)
            ):
                n = st.getRandom(3)
    ...
    def onTalk(self, npc, player):
        ...
        if npcId == 30524 and cond == 0:
            ...
            npcId == 30524
            and cond
            and st.getQuestItemsCount(PIPIS_LETTER) == 0
            and id == STARTING
        ):
            htmltext = "30524-01.htm"
            ...
            and (
                (
                    st.getQuestItemsCount(CHALIS_PAY)
            ...
            npcId == 30517
            and cond
            and st.getQuestItemsCount(CHALIS_AXE) == 1
            and st.getInt("id") < 20
        ):
            ...
            npcId == 30525
            and cond
            and st.getQuestItemsCount(BRONKS_INGOT) == 1
            and st.getInt("id") < 20
        ):
            ...
            npcId == 30538
            and cond
            and st.getQuestItemsCount(ZIMENFS_POTION) == 1
            and st.getInt("id") < 20
        ):
            ...
            npcId == 30556
            and cond
            and st.getQuestItemsCount(BEAR_PIC) == 1
            and st.getQuestItemsCount(HONEY_JAR) < 5
        ):
            ...
            npcId == 30556
            and cond
            and st.getQuestItemsCount(TARANTULA_PIC) == 1
            and st.getQuestItemsCount(BEAD) < 20
        ):
