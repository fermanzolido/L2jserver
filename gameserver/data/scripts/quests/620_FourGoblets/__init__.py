    ...
    def onTalk(Self, npc, player):
        ...
        if npcId == NAMELESS_SPIRIT:
            if int(st.get("cond")) == 0:
                ...
                if (
                    st.getQuestItemsCount(GOBLETS[0]) >= 1
                    and st.getQuestItemsCount(GOBLETS[1]) >= 1
                    and st.getQuestItemsCount(GOBLETS[2]) >= 1
                    and st.getQuestItemsCount(GOBLETS[3]) >= 1
                ):
            ...
            if st.getInt("cond") == 1:
                if (
                    st.getQuestItemsCount(GOBLETS[0])
                    + st.getQuestItemsCount(GOBLETS[1])
                    + st.getQuestItemsCount(GOBLETS[2])
                    + st.getQuestItemsCount(GOBLETS[3])
                    == 1
                ):
