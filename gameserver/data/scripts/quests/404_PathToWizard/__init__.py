...
class Quest(JQuest):
    ...
    def onTalk(self, npc, player):
        ...
        if npcId == 30391 and st.getInt("cond") == 0:
            ...
            npcId == 30411
            and st.getInt("cond") != 0
            and st.getQuestItemsCount(MAP_OF_LUSTER) == 0
            and st.getQuestItemsCount(FLAME_EARING) == 0
        ):
            ...
            and st.getInt("cond") != 0
            and st.getQuestItemsCount(MAP_OF_LUSTER) != 0
            and st.getQuestItemsCount(KEY_OF_FLAME) == 0
        ):
            ...
            and st.getInt("cond") != 0
            and st.getQuestItemsCount(FLAME_EARING) != 0
            and st.getQuestItemsCount(BROKEN_BRONZE_MIRROR) == 0
            and st.getQuestItemsCount(WIND_BANGEL) == 0
        ):
            ...
            and st.getInt("cond") != 0
            and st.getQuestItemsCount(BROKEN_BRONZE_MIRROR) != 0
            and st.getQuestItemsCount(WIND_FEATHER) == 0
        ):
            ...
            st.takeItems(
                BROKEN_BRONZE_MIRROR, st.getQuestItemsCount(BROKEN_BRONZE_MIRROR)
            )
            ...
            and st.getInt("cond") != 0
            and st.getQuestItemsCount(WIND_BANGEL) != 0
            and st.getQuestItemsCount(RAMAS_DIARY) == 0
            and st.getQuestItemsCount(WATER_NECKLACE) == 0
        ):
            ...
            and st.getInt("cond") != 0
            and st.getQuestItemsCount(RAMAS_DIARY) != 0
            and st.getQuestItemsCount(SPARKLE_PEBBLE) < 2
        ):
            ...
            and st.getInt("cond") != 0
            and st.getQuestItemsCount(WATER_NECKLACE) != 0
            and st.getQuestItemsCount(RUST_GOLD_COIN) == 0
            and st.getQuestItemsCount(EARTH_RING) == 0
        ):
            ...
            and st.getInt("cond") != 0
            and st.getQuestItemsCount(RUST_GOLD_COIN) != 0
            and st.getQuestItemsCount(RED_SOIL) == 0
        ):
