...
class Quest(JQuest):
    ...
    def onTalk(self, npc, player):
        ...
        if npcId == 30476 and st.getInt("cond") == 0 and st.getInt("onlyone") == 0:
            ...
            and st.getQuestItemsCount(KAIRAS_LETTER1_ID)
        ):
            ...
            and st.getInt("cond") == 1
            and (
                st.getQuestItemsCount(METHEUS_FUNERAL_JAR_ID)
                or st.getQuestItemsCount(KASANDRAS_REMAINS_ID)
            )
        ):
            ...
            and st.getInt("cond") == 1
            and (
                st.getQuestItemsCount(HERBALISM_TEXTBOOK_ID)
                or st.getQuestItemsCount(IXIAS_LIST_ID)
            )
        ):
            ...
            npcId == 30476
            and st.getInt("cond") == 1
            and st.getQuestItemsCount(ALDERS_SKULL1_ID)
        ):
            ...
            and st.getInt("cond") == 1
            and (
                st.getQuestItemsCount(ALDERS_SKULL2_ID)
                or st.getQuestItemsCount(ALDERS_RECEIPT_ID)
            )
        ):
            ...
            npcId == 30476
            and st.getInt("cond") == 1
            and st.getQuestItemsCount(REVELATIONS_MANUSCRIPT_ID)
        ):
            htmltext = "30476-11.htm"
        elif (
            npcId == 30476
            and st.getInt("cond") == 1
            and st.getQuestItemsCount(KAIRAS_INSTRUCTIONS_ID)
            and player.getLevel() < 38
        ):
            ...
            npcId == 30476
            and st.getInt("cond") == 1
            and st.getQuestItemsCount(KAIRAS_RECOMMEND_ID)
            and player.getLevel() >= 38
        ):
            ...
            npcId == 30476
            and st.getInt("cond") == 1
            and st.getQuestItemsCount(PALUS_CHARM_ID)
        ):
            ...
            npcId == 30614
            and st.getInt("cond") == 1
            and st.getQuestItemsCount(METHEUS_FUNERAL_JAR_ID)
            and st.getQuestItemsCount(KASANDRAS_REMAINS_ID) == 0
        ):
            htmltext = "30614-02.htm"
        elif (
            npcId == 30614
            and st.getInt("cond") == 1
            and st.getQuestItemsCount(METHEUS_FUNERAL_JAR_ID) == 0
            and st.getQuestItemsCount(KASANDRAS_REMAINS_ID)
        ):
            ...
            npcId == 30614
            and st.getInt("cond") == 1
            and st.getQuestItemsCount(BELLADONNA_ID)
        ):
            ...
            and st.getInt("cond") == 1
            and (
                st.getQuestItemsCount(ALDERS_SKULL1_ID)
                or st.getQuestItemsCount(ALDERS_SKULL2_ID)
                or st.getQuestItemsCount(ALDERS_RECEIPT_ID)
                or st.getQuestItemsCount(REVELATIONS_MANUSCRIPT_ID)
                or st.getQuestItemsCount(KAIRAS_INSTRUCTIONS_ID)
                or st.getQuestItemsCount(KAIRAS_RECOMMEND_ID)
            )
        ):
            ...
            npcId == 30463
            and st.getInt("cond") == 1
            and st.getQuestItemsCount(HERBALISM_TEXTBOOK_ID)
        ):
            ...
            npcId == 30463
            and st.getInt("cond") == 1
            and st.getQuestItemsCount(IXIAS_LIST_ID)
            and (
                st.getQuestItemsCount(MEDUSA_ICHOR_ID) < 10
                or st.getQuestItemsCount(M_SPIDER_FLUIDS_ID) < 10
                or st.getQuestItemsCount(DEAD_SEEKER_DUNG_ID) < 10
                or st.getQuestItemsCount(TYRANTS_BLOOD_ID) < 10
                or st.getQuestItemsCount(NIGHTSHADE_ROOT_ID) < 10
            )
        ):
            ...
            and st.getInt("cond") == 1
            and st.getQuestItemsCount(IXIAS_LIST_ID)
            and st.getQuestItemsCount(MEDUSA_ICHOR_ID) >= 10
            and st.getQuestItemsCount(M_SPIDER_FLUIDS_ID) >= 10
            and st.getQuestItemsCount(DEAD_SEEKER_DUNG_ID) >= 10
            and st.getQuestItemsCount(TYRANTS_BLOOD_ID) >= 10
            and st.getQuestItemsCount(NIGHTSHADE_ROOT_ID) >= 10
        ):
            ...
            st.takeItems(
                DEAD_SEEKER_DUNG_ID, st.getQuestItemsCount(DEAD_SEEKER_DUNG_ID)
            )
            ...
            npcId == 30114
            and st.getInt("cond") == 1
            and st.getQuestItemsCount(ALDERS_SKULL2_ID)
        ):
            htmltext = "30114-01.htm"
        elif (
            npcId == 30114
            and st.getInt("cond") == 1
            and st.getQuestItemsCount(ALDERS_RECEIPT_ID)
        ):
            ...
            and st.getInt("cond") == 1
            and (
                st.getQuestItemsCount(REVELATIONS_MANUSCRIPT_ID)
                or st.getQuestItemsCount(KAIRAS_INSTRUCTIONS_ID)
                or st.getQuestItemsCount(KAIRAS_RECOMMEND_ID)
            )
        ):
            ...
            and st.getInt("cond") == 1
            and st.getQuestItemsCount(PALUS_CHARM_ID)
            and st.getQuestItemsCount(THIFIELS_LETTER_ID)
        ):
            ...
            and st.getInt("cond") == 1
            and st.getQuestItemsCount(PALUS_CHARM_ID)
            and st.getQuestItemsCount(ARKENIAS_NOTE_ID)
        ):
            ...
            and st.getInt("cond") == 1
            and st.getQuestItemsCount(PALUS_CHARM_ID)
            and st.getQuestItemsCount(ARKENIAS_LETTER_ID)
        ):
            ...
            and st.getQuestItemsCount(ARKENIAS_NOTE_ID)
            and (
                st.getQuestItemsCount(RED_FAIRY_DUST_ID) < 1
                or st.getQuestItemsCount(TIMIRIRAN_SAP_ID) < 1
            )
        ):
            ...
            and (
                st.getQuestItemsCount(RED_FAIRY_DUST_ID) >= 1
                and st.getQuestItemsCount(TIMIRIRAN_SAP_ID) >= 1
            )
        ):
            ...
            and st.getQuestItemsCount(PALUS_CHARM_ID)
            and st.getQuestItemsCount(ARKENIAS_NOTE_ID)
            and st.getQuestItemsCount(RED_FAIRY_DUST_ID) == 0
            and st.getQuestItemsCount(PIXY_GARNET_ID) == 0
        ):
            ...
            and st.getQuestItemsCount(ARKENIAS_NOTE_ID)
            and st.getQuestItemsCount(RED_FAIRY_DUST_ID) == 0
            and st.getQuestItemsCount(PIXY_GARNET_ID)
            and (
                st.getQuestItemsCount(GRANDIS_SKULL_ID) < 10
                or st.getQuestItemsCount(KARUL_BUGBEAR_SKULL_ID) < 10
                or st.getQuestItemsCount(BREKA_OVERLORD_SKULL_ID) < 10
                or st.getQuestItemsCount(LETO_OVERLORD_SKULL_ID) < 10
            )
        ):
            ...
            and st.getQuestItemsCount(RED_FAIRY_DUST_ID) == 0
            and st.getQuestItemsCount(PIXY_GARNET_ID)
            and st.getQuestItemsCount(GRANDIS_SKULL_ID) >= 10
            and st.getQuestItemsCount(KARUL_BUGBEAR_SKULL_ID) >= 10
            and st.getQuestItemsCount(BREKA_OVERLORD_SKULL_ID) >= 10
            and st.getQuestItemsCount(LETO_OVERLORD_SKULL_ID) >= 10
        ):
            ...
            st.takeItems(
                KARUL_BUGBEAR_SKULL_ID, st.getQuestItemsCount(KARUL_BUGBEAR_SKULL_ID)
            )
            st.takeItems(
                BREKA_OVERLORD_SKULL_ID, st.getQuestItemsCount(BREKA_OVERLORD_SKULL_ID)
            )
            st.takeItems(
                LETO_OVERLORD_SKULL_ID, st.getQuestItemsCount(LETO_OVERLORD_SKULL_ID)
            )
        elif (
            npcId == 31845
            and st.getInt("cond") == 1
            and st.getQuestItemsCount(PALUS_CHARM_ID)
            and st.getQuestItemsCount(ARKENIAS_NOTE_ID)
            and st.getQuestItemsCount(RED_FAIRY_DUST_ID)
            and st.getQuestItemsCount(PIXY_GARNET_ID) == 0
        ):
            ...
            and st.getQuestItemsCount(PALUS_CHARM_ID)
            and st.getQuestItemsCount(ARKENIAS_NOTE_ID)
            and st.getQuestItemsCount(TIMIRIRAN_SAP_ID) == 0
            and st.getQuestItemsCount(TIMIRIRAN_SEED_ID) == 0
        ):
            ...
            and st.getQuestItemsCount(ARKENIAS_NOTE_ID)
            and st.getQuestItemsCount(TIMIRIRAN_SAP_ID) == 0
            and st.getQuestItemsCount(TIMIRIRAN_SEED_ID)
            and st.getQuestItemsCount(BLACK_WILLOW_LEAF_ID) == 0
        ):
            ...
            and st.getQuestItemsCount(TIMIRIRAN_SAP_ID) == 0
            and st.getQuestItemsCount(TIMIRIRAN_SEED_ID)
            and st.getQuestItemsCount(BLACK_WILLOW_LEAF_ID)
        ):
            ...
            and st.getQuestItemsCount(PALUS_CHARM_ID)
            and st.getQuestItemsCount(ARKENIAS_NOTE_ID)
            and st.getQuestItemsCount(TIMIRIRAN_SAP_ID)
            and st.getQuestItemsCount(TIMIRIRAN_SEED_ID) == 0
        ):
