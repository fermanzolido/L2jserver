...
def has_review(st):
    return (
        st.getQuestItemsCount(MIRIENS_REVIEW1_ID)
...
def has_dish(st):
    return (
        st.getQuestItemsCount(JONAS_STEAK_DISH1_ID)
...
def special_ingredients(st):
    return (
        st.getQuestItemsCount(WHITE_MANDRAGORA_SAP_ID)
...
def ingredients_count(st):
    return (
        st.getQuestItemsCount(RED_MANDRAGORA_SAP_ID)
...
class Quest(JQuest):
    ...
    def onTalk(self, npc, player):
        ...
        if npcId == 30469 and st.getInt("cond") == 0:
            ...
            npcId == 30469
            and st.getInt("cond")
            and ingredients_count(st) == 0
            and not has_list(st)
            and has_dish(st)
            and not has_review(st)
        ):
            ...
            and has_list(st)
            and ingredients_count(st) < 5
            and not st.getQuestItemsCount(SONIAS_BOTANYBOOK_ID)
            and (
                st.getQuestItemsCount(RED_MANDRAGORA_SAP_ID)
                + st.getQuestItemsCount(WHITE_MANDRAGORA_SAP_ID)
                == 0
            ...
            and has_list(st)
            and ingredients_count(st) < 5
            and st.getQuestItemsCount(SONIAS_BOTANYBOOK_ID)
            and (
                st.getQuestItemsCount(RED_MANDRAGORA_ROOT_ID)
                + st.getQuestItemsCount(WHITE_MANDRAGORA_ROOT_ID)
            )
            < 40
            and (
                st.getQuestItemsCount(RED_MANDRAGORA_SAP_ID)
            ...
            >= 40
            and st.getQuestItemsCount(WHITE_MANDRAGORA_ROOT_ID) < 40
            and (
                st.getQuestItemsCount(RED_MANDRAGORA_SAP_ID)
                + st.getQuestItemsCount(WHITE_MANDRAGORA_SAP_ID)
                == 0
            ...
            and has_list(st)
            and ingredients_count(st) < 5
            and st.getQuestItemsCount(SONIAS_BOTANYBOOK_ID) == 0
            and (
                st.getQuestItemsCount(RED_MANDRAGORA_SAP_ID)
                + st.getQuestItemsCount(WHITE_MANDRAGORA_SAP_ID)
                > 0
            ...
            and has_list(st)
            and ingredients_count(st) < 5
            and st.getQuestItemsCount(JAYCUBS_INSECTBOOK_ID) == 0
            and (
                st.getQuestItemsCount(HONEY_ID) + st.getQuestItemsCount(GOLDEN_HONEY_ID)
                == 0
            )
        ):
            ...
            and has_list(st)
            and ingredients_count(st) < 5
            and st.getQuestItemsCount(JAYCUBS_INSECTBOOK_ID)
            and st.getQuestItemsCount(NECTAR_ID) < 20
        ):
            ...
            and st.getQuestItemsCount(JAYCUBS_INSECTBOOK_ID)
            and st.getQuestItemsCount(NECTAR_ID) >= 20
            and st.getQuestItemsCount(ROYAL_JELLY_ID) < 10
        ):
            ...
            and has_list(st)
            and ingredients_count(st) < 5
            and st.getQuestItemsCount(PANOS_CONTRACT_ID) == 0
            and st.getQuestItemsCount(DIONIAN_POTATO_ID) == 0
        ):
            ...
            and has_list(st)
            and ingredients_count(st) < 5
            and st.getQuestItemsCount(PANOS_CONTRACT_ID)
            and st.getQuestItemsCount(HOBGOBLIN_AMULET_ID) < 30
        ):
            ...
            and ingredients_count(st) < 5
            and st.getQuestItemsCount(PANOS_CONTRACT_ID) == 0
            and st.getQuestItemsCount(DIONIAN_POTATO_ID)
        ):
            ...
            and has_list(st)
            and ingredients_count(st) < 5
            and st.getQuestItemsCount(GLYVKAS_BOTANYBOOK_ID) == 0
            and (
                st.getQuestItemsCount(GREEN_MOSS_BUNDLE_ID)
                + st.getQuestItemsCount(BROWN_MOSS_BUNDLE_ID)
                == 0
            ...
            and has_list(st)
            and ingredients_count(st) < 5
            and st.getQuestItemsCount(GLYVKAS_BOTANYBOOK_ID)
            and (
                st.getQuestItemsCount(GREEN_MARSH_MOSS_ID)
                + st.getQuestItemsCount(BROWN_MARSH_MOSS_ID)
                < 20
            )
        ):
            ...
            and st.getQuestItemsCount(BROWN_MARSH_MOSS_ID) < 20
        ):
            ...
            and has_list(st)
            and ingredients_count(st) < 5
            and st.getQuestItemsCount(ROLANTS_CREATUREBOOK_ID) == 0
            and st.getQuestItemsCount(MONSTER_EYE_MEAT_ID) == 0
        ):
            ...
            and has_list(st)
            and ingredients_count(st) < 5
            and st.getQuestItemsCount(ROLANTS_CREATUREBOOK_ID)
            and st.getQuestItemsCount(MONSTER_EYE_BODY_ID) < 30
        ):
            ...
            and ingredients_count(st) < 5
            and st.getQuestItemsCount(ROLANTS_CREATUREBOOK_ID) == 0
            and st.getQuestItemsCount(MONSTER_EYE_MEAT_ID) == 1
        ):
