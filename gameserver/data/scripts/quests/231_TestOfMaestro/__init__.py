...
class Quest(JQuest):
    ...
    def onTalk(self, npc, player):
        ...
        if npcId == 30531:
            ...
            if progress in [1, 11, 16] and not st.getQuestItemsCount(
                RECOMMENDATION_OF_BALANKI
            ):
            ...
            if progress in [1, 7, 16] and not st.getQuestItemsCount(
                RECOMMENDATION_OF_ARIN
            ):
            ...
            if progress in [1, 7, 11] and not st.getQuestItemsCount(
                RECOMMENDATION_OF_FILAUR
            ):
