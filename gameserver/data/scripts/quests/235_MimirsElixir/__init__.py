    ...
    def onTalk(self, npc, player):
        ...
        if npcId == LADD:
            ...
            # Ah, you got the blood fire!  Time to mix them up!
                ...
                cond == 7
                and st.getQuestItemsCount(PURE_SILVER)
                and st.getQuestItemsCount(TRUE_GOLD)
            ):
            ...
            # Finally, all is done...time to learn how to use the Elixir...
                ...
                st.takeItems(
                    MIMIRS_ELIXIR, -1
                )  # remove this line for compatibility with L2JServer revisions prior to 376
            ...
            # aha!  Here is the sage's stone!  Cool, now we can make true gold
                ...
                st.set("cond", "5")
                htmltext = (
                    "30718-03.htm"  # here you go...take the gold.  Now go back to ladd.
                )
            elif cond >= 5:
