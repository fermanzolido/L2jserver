...
class Quest(JQuest):
    ...
    def onTalk(self, npc, player):
        ...
        if npcId == 30702 and step == 0 and onlyone == 0:
            ...
            npcId == 30702
            and step == 1
            and st.getQuestItemsCount(BERNARDS_INTRODUCTION)
        ):
            ...
            npcId == 30626 and step == 4 and st.getQuestItemsCount(HUNTERS_RUNE1) == 10
        ):
            ...
            npcId == 30717
            and step == 11
            and st.getQuestItemsCount(STAKATO_CHITIN)
            and st.getQuestItemsCount(MITHRIL_CLIP)
            and st.getQuestItemsCount(ST_BOWSTRING)
            and st.getQuestItemsCount(MANASHENS_HORN)
        ):
    ...
    def onKill(self, npc, player, isPet):
        ...
        if (
            ...
            if dropcondition == 1:
                ...
                if (
                    st.getQuestItemsCount(MITHRIL_CLIP)
                    and st.getQuestItemsCount(ST_BOWSTRING)
                    and st.getQuestItemsCount(MANASHENS_HORN)
                ):
                    giveMiddle(st, itemid, step)
                ...
                if (
                    ...
                    st.getQuestItemsCount(ST_BOWSTRING)
                    and st.getQuestItemsCount(MANASHENS_HORN)
                    and st.getQuestItemsCount(STAKATO_CHITIN)
                ):
                    giveMiddle(st, itemid, step)
