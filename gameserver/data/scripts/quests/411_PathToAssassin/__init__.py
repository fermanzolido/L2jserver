...
class Quest(JQuest):
    ...
    def onEvent(self, event, st):
        ...
        if event == "1":
            if (
                level >= 19
                and classId == 0x1F
                and st.getQuestItemsCount(IRON_HEART) == 0
            ):
                st.set("cond", "1")
                st.setState(STARTED)
                ...
                level >= 19
                and classId == 0x1F
                and st.getQuestItemsCount(IRON_HEART) == 1
            ):
    ...
    def onTalk(self, npc, player):
        ...
        if npcId == 30416 and st.getInt("cond") == 0:
            ...
            if (
                st.getQuestItemsCount(ARKENIAS_LETTER) == 0
                and st.getQuestItemsCount(LEIKANS_NOTE) == 0
                and st.getQuestItemsCount(SHILENS_TEARS) == 0
                and st.getQuestItemsCount(ARKENIA_RECOMMEND) == 1
                and st.getQuestItemsCount(IRON_HEART) == 0
            ):
                ...
                st.getQuestItemsCount(ARKENIAS_LETTER) == 1
                and st.getQuestItemsCount(LEIKANS_NOTE) == 0
                and st.getQuestItemsCount(SHILENS_TEARS) == 0
                and st.getQuestItemsCount(ARKENIA_RECOMMEND) == 0
                and st.getQuestItemsCount(IRON_HEART) == 0
                and st.getQuestItemsCount(SHILENS_CALL) == 0
            ):
                htmltext = "30416-07.htm"
            elif (
                st.getQuestItemsCount(ARKENIAS_LETTER) == 0
                and st.getQuestItemsCount(LEIKANS_NOTE) == 1
                and st.getQuestItemsCount(SHILENS_TEARS) == 0
                and st.getQuestItemsCount(ARKENIA_RECOMMEND) == 0
                and st.getQuestItemsCount(IRON_HEART) == 0
                and st.getQuestItemsCount(SHILENS_CALL) == 0
                ...
                st.getQuestItemsCount(ARKENIAS_LETTER) == 0
                and st.getQuestItemsCount(LEIKANS_NOTE) == 0
                and st.getQuestItemsCount(SHILENS_TEARS) == 1
                and st.getQuestItemsCount(ARKENIA_RECOMMEND) == 0
                and st.getQuestItemsCount(IRON_HEART) == 0
                and st.getQuestItemsCount(SHILENS_CALL) == 0
            ):
                ...
                and st.getQuestItemsCount(ARKENIA_RECOMMEND) == 0
                and st.getQuestItemsCount(IRON_HEART) == 0
                and st.getQuestItemsCount(SHILENS_CALL) == 1
            ):
            ...
            if (
                ...
                and st.getQuestItemsCount(IRON_HEART) == 0
                and st.getQuestItemsCount(SHILENS_CALL) == 0
                and st.getQuestItemsCount(ONYX_BEASTS_MOLAR) == 0
            ):
                ...
                and st.getQuestItemsCount(IRON_HEART) == 0
                and st.getQuestItemsCount(SHILENS_CALL) == 0
                and st.getQuestItemsCount(ONYX_BEASTS_MOLAR) < 10
            ):
                ...
                st.getInt("cond") >= 1
                and st.getQuestItemsCount(ARKENIAS_LETTER) == 0
                and st.getQuestItemsCount(LEIKANS_NOTE) == 0
                and st.getQuestItemsCount(SHILENS_TEARS) == 0
                and st.getQuestItemsCount(ARKENIA_RECOMMEND) == 0
                and st.getQuestItemsCount(IRON_HEART) == 0
