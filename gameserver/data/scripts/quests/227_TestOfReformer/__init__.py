...
class Quest(JQuest):
    ...
    def onTalk(self, npc, player):
        ...
        if npcId == 30118 and st.getInt("cond") == 0 and st.getInt("onlyone") == 0:
            ...
            and st.getQuestItemsCount(HUGE_NAIL) >= 1
        ):
            ...
            and st.getQuestItemsCount(LETTER_OF_INTRODUCTION) > 0
        ):
            htmltext = "30666-01.htm"
        elif (
            npcId == 30666
            and st.getInt("cond") == 5
            and st.getQuestItemsCount(SLAS_LETTER) > 0
        ):
            ...
            npcId == 30666
            and st.getInt("cond") == 18
            and st.getQuestItemsCount(KATARIS_LETTER) > 0
            and st.getQuestItemsCount(KAKANS_LETTER) > 0
            and st.getQuestItemsCount(NYAKURIS_LETTER) > 0
            and st.getQuestItemsCount(RAMUSS_LETTER) > 0
        ):
            ...
            npcId == 30669
            and st.getInt("cond") == 11
            and st.getQuestItemsCount(GREETINGS) > 0
        ):
            ...
            npcId == 30667
            and st.getQuestItemsCount(BONE_FRAGMENT4) > 0
            and st.getQuestItemsCount(BONE_FRAGMENT5) > 0
            and st.getQuestItemsCount(BONE_FRAGMENT6) > 0
            and st.getQuestItemsCount(BONE_FRAGMENT7) > 0
            and st.getQuestItemsCount(BONE_FRAGMENT8) > 0
        ):
    ...
    def onKill(self, npc, player, isPet):
        ...
        if npcId == 27099:
            if (
                st.getInt("cond") == 1
                and st.getQuestItemsCount(RIPPED_DIARY) < 7
                and st.getQuestItemsCount(BOOK_OF_REFORM) >= 1
            ):
...
for item in list(range(2822, 2840)) + [3037]:
