...
class Quest(JQuest):
    ...
    def onEvent(self, event, st):
        ...
        if event == "1":
            ...
            if (
                level >= 19
                and classId == 0x1F
                and st.getQuestItemsCount(GAZE_OF_ABYSS) == 0
            ):
                ...
                level >= 19
                and classId == 0x1F
                and st.getQuestItemsCount(GAZE_OF_ABYSS) == 1
            ):
    ...
    def onTalk(self, npc, player):
        ...
        if npcId == 30329 and st.getInt("cond") == 0:
            ...
            if (
                st.getQuestItemsCount(PALLUS_TALISMAN) == 1
                and st.getQuestItemsCount(LYCANTHROPE_SKULL) == 0
            ):
                htmltext = "30329-07.htm"
            elif (
                st.getQuestItemsCount(PALLUS_TALISMAN) == 1
                and st.getQuestItemsCount(LYCANTHROPE_SKULL) > 0
                and st.getQuestItemsCount(LYCANTHROPE_SKULL) < 13
            ):
            ...
            elif st.getQuestItemsCount(MORTE_TALISMAN) or st.getQuestItemsCount(
                VIRGILS_LETTER
            ):
            ...
            if st.getQuestItemsCount(VIRGILS_LETTER):
                ...
                st.getQuestItemsCount(MORTE_TALISMAN)
                and st.getQuestItemsCount(TRIMDEN_SILK) == 0
                and st.getQuestItemsCount(PREDATOR_CARAPACE) == 0
            ):
                ...
                st.getQuestItemsCount(MORTE_TALISMAN)
                and st.getQuestItemsCount(TRIMDEN_SILK) >= 5
                and st.getQuestItemsCount(PREDATOR_CARAPACE) > 0
            ):
    ...
    def onKill(self, npc, player, isPet):
        ...
        if npcId == 20049:
            ...
            if (
                st.getInt("cond")
                and st.getQuestItemsCount(PALLUS_TALISMAN) == 1
                and st.getQuestItemsCount(LYCANTHROPE_SKULL) < 13
            ):
            ...
            if (
                st.getInt("cond")
                and st.getQuestItemsCount(MORTE_TALISMAN) == 1
                and st.getQuestItemsCount(PREDATOR_CARAPACE) < 1
            ):
                st.giveItems(PREDATOR_CARAPACE, 1)
                st.playSound("ItemSound.quest_middle")
                if (
                    st.getQuestItemsCount(TRIMDEN_SILK) >= 5
                    and st.getQuestItemsCount(PREDATOR_CARAPACE) > 0
                ):
                    st.set("cond", "5")
        elif npcId == 20043:
