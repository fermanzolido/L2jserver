...
class Quest(JQuest):
    ...
    def onTalk(self, npc, player):
        ...
        if npcId == 30104 and st.getInt("cond") == 0 and st.getInt("onlyone") == 0:
            ...
            npcId == 30104
            and st.getInt("cond") >= 1
            and st.getQuestItemsCount(RING_OF_TESTIMONY1_ID) == 1
        ):
            if (
                st.getQuestItemsCount(OLD_ACCOUNT_BOOK_ID)
                and st.getQuestItemsCount(BLESSED_SEED_ID)
                and st.getQuestItemsCount(RECIPE_OF_EMILLY_ID)
                and st.getQuestItemsCount(LILITH_ELVEN_WAFER_ID)
            ):
            ...
            npcId == 30104
            and st.getInt("cond") >= 1
            and st.getQuestItemsCount(PARMANS_INSTRUCTIONS_ID) == 1
        ):
            ...
            npcId == 30104
            and st.getInt("cond") >= 1
            and st.getQuestItemsCount(RING_OF_TESTIMONY2_ID)
            and st.getQuestItemsCount(PARMANS_LETTER_ID)
            and st.getQuestItemsCount(MAPHR_TABLET_FRAGMENT_ID) == 0
        ):
            ...
            and st.getInt("cond") >= 1
            and st.getQuestItemsCount(RING_OF_TESTIMONY2_ID)
            and st.getQuestItemsCount(MAPHR_TABLET_FRAGMENT_ID)
        ):
            ...
            npcId == 30531
            and st.getInt("cond") >= 1
            and st.getQuestItemsCount(OLD_ACCOUNT_BOOK_ID) == 0
            and st.getQuestItemsCount(COLLECTION_LICENSE_ID) == 0
            and st.getQuestItemsCount(RING_OF_TESTIMONY1_ID) == 1
        ):
            ...
            if (
                st.getQuestItemsCount(RECEIPT_OF_CONTRIBUTION1_ID)
                and st.getQuestItemsCount(RECEIPT_OF_CONTRIBUTION2_ID)
                and st.getQuestItemsCount(RECEIPT_OF_CONTRIBUTION3_ID)
                and st.getQuestItemsCount(RECEIPT_OF_CONTRIBUTION4_ID)
            ...
            and st.getInt("cond") >= 1
            and st.getQuestItemsCount(RING_OF_TESTIMONY1_ID)
            and st.getQuestItemsCount(OLD_ACCOUNT_BOOK_ID)
            and st.getQuestItemsCount(COLLECTION_LICENSE_ID) == 0
        ):
            ...
            and st.getQuestItemsCount(RING_OF_TESTIMONY1_ID)
            and st.getQuestItemsCount(COLLECTION_LICENSE_ID)
            and st.getQuestItemsCount(LOCKIRINS_NOTICE1_ID)
            and st.getQuestItemsCount(RECEIPT_OF_CONTRIBUTION1_ID) == 0
            and st.getQuestItemsCount(CONTRIBUTION_OF_CHALI_ID) == 0
        ):
            ...
            and st.getQuestItemsCount(RECEIPT_OF_CONTRIBUTION1_ID) == 0
            and st.getQuestItemsCount(CONTRIBUTION_OF_CHALI_ID) == 0
            and st.getQuestItemsCount(LOCKIRINS_NOTICE1_ID) == 0
        ):
            ...
            and st.getQuestItemsCount(RING_OF_TESTIMONY1_ID)
            and st.getQuestItemsCount(COLLECTION_LICENSE_ID)
            and st.getQuestItemsCount(RECEIPT_OF_CONTRIBUTION1_ID)
        ):
            ...
            and st.getQuestItemsCount(RING_OF_TESTIMONY1_ID)
            and st.getQuestItemsCount(COLLECTION_LICENSE_ID)
            and st.getQuestItemsCount(LOCKIRINS_NOTICE2_ID)
            and st.getQuestItemsCount(LOCKIRINS_NOTICE2_ID) == 1
            and st.getQuestItemsCount(RECEIPT_OF_CONTRIBUTION2_ID) == 0
            and (
            ...
            and st.getQuestItemsCount(RING_OF_TESTIMONY1_ID)
            and st.getQuestItemsCount(COLLECTION_LICENSE_ID)
            and st.getQuestItemsCount(LOCKIRINS_NOTICE2_ID) == 0
            and st.getQuestItemsCount(RECEIPT_OF_CONTRIBUTION2_ID) == 0
            and (
                st.getQuestItemsCount(CONTRIBUTION_OF_MION_ID)
                + st.getQuestItemsCount(CONTRIBUTION_OF_MARIFE_ID)
            ...
            and st.getQuestItemsCount(RING_OF_TESTIMONY1_ID)
            and st.getQuestItemsCount(COLLECTION_LICENSE_ID)
            and st.getQuestItemsCount(LOCKIRINS_NOTICE3_ID)
            and st.getQuestItemsCount(RECEIPT_OF_CONTRIBUTION3_ID) == 0
            and st.getQuestItemsCount(PROCURATION_OF_TOROCCO_ID) == 0
        ):
            ...
            and st.getQuestItemsCount(RECEIPT_OF_CONTRIBUTION3_ID) == 0
            and st.getQuestItemsCount(PROCURATION_OF_TOROCCO_ID) == 0
            and st.getQuestItemsCount(LOCKIRINS_NOTICE3_ID) == 0
            and st.getQuestItemsCount(RING_OF_TESTIMONY1_ID)
            and st.getQuestItemsCount(COLLECTION_LICENSE_ID)
        ):
            ...
            and st.getQuestItemsCount(RING_OF_TESTIMONY1_ID)
            and st.getQuestItemsCount(COLLECTION_LICENSE_ID)
            and st.getQuestItemsCount(PROCURATION_OF_TOROCCO_ID)
            and st.getQuestItemsCount(LOCKIRINS_NOTICE3_ID) == 0
            and st.getQuestItemsCount(RECEIPT_OF_CONTRIBUTION3_ID) == 0
        ):
            ...
            and st.getQuestItemsCount(RING_OF_TESTIMONY1_ID)
            and st.getQuestItemsCount(COLLECTION_LICENSE_ID)
            and st.getQuestItemsCount(LOCKIRINS_NOTICE4_ID)
            and st.getQuestItemsCount(RECEIPT_OF_CONTRIBUTION4_ID) == 0
            and st.getQuestItemsCount(RECEIPT_OF_BOLTER_ID) == 0
        ):
            ...
            and st.getQuestItemsCount(RECEIPT_OF_CONTRIBUTION4_ID) == 0
            and st.getQuestItemsCount(RECEIPT_OF_BOLTER_ID) == 0
            and st.getQuestItemsCount(LOCKIRINS_NOTICE4_ID) == 0
            and st.getQuestItemsCount(RING_OF_TESTIMONY1_ID)
            and st.getQuestItemsCount(COLLECTION_LICENSE_ID)
        ):
            ...
            and st.getQuestItemsCount(RING_OF_TESTIMONY1_ID)
            and st.getQuestItemsCount(COLLECTION_LICENSE_ID)
            and st.getQuestItemsCount(RECEIPT_OF_BOLTER_ID)
            and st.getQuestItemsCount(RECEIPT_OF_CONTRIBUTION4_ID) == 0
            and st.getQuestItemsCount(LOCKIRINS_NOTICE4_ID) == 0
        ):
            ...
            and st.getQuestItemsCount(RING_OF_TESTIMONY1_ID)
            and st.getQuestItemsCount(COLLECTION_LICENSE_ID)
            and st.getQuestItemsCount(LOCKIRINS_NOTICE5_ID)
            and st.getQuestItemsCount(RECEIPT_OF_CONTRIBUTION5_ID) == 0
            and st.getQuestItemsCount(CONTRIBUTION_OF_TOMA_ID) == 0
        ):
            ...
            and st.getQuestItemsCount(RECEIPT_OF_CONTRIBUTION5_ID) == 0
            and st.getQuestItemsCount(CONTRIBUTION_OF_TOMA_ID) == 0
            and st.getQuestItemsCount(LOCKIRINS_NOTICE5_ID) == 0
            and st.getQuestItemsCount(RING_OF_TESTIMONY1_ID)
            and st.getQuestItemsCount(COLLECTION_LICENSE_ID)
        ):
            ...
            and st.getInt("cond") >= 1
            and st.getQuestItemsCount(RECEIPT_OF_CONTRIBUTION2_ID) == 0
            and st.getQuestItemsCount(CONTRIBUTION_OF_MION_ID) == 0
            and st.getQuestItemsCount(LOCKIRINS_NOTICE2_ID) == 0
            and st.getQuestItemsCount(RING_OF_TESTIMONY1_ID)
            and st.getQuestItemsCount(COLLECTION_LICENSE_ID)
        ):
            ...
            and st.getInt("cond") >= 1
            and st.getQuestItemsCount(RECEIPT_OF_CONTRIBUTION2_ID) == 0
            and st.getQuestItemsCount(CONTRIBUTION_OF_MARIFE_ID) == 0
            and st.getQuestItemsCount(LOCKIRINS_NOTICE2_ID) == 0
            and st.getQuestItemsCount(MARIFES_REQUEST_ID) == 0
            and st.getQuestItemsCount(RING_OF_TESTIMONY1_ID)
            and st.getQuestItemsCount(COLLECTION_LICENSE_ID)
        ):
            ...
            and st.getQuestItemsCount(RING_OF_TESTIMONY1_ID)
            and st.getQuestItemsCount(COLLECTION_LICENSE_ID)
            and st.getQuestItemsCount(CONTRIBUTION_OF_MARIFE_ID)
            and st.getQuestItemsCount(RECEIPT_OF_CONTRIBUTION2_ID) == 0
            and st.getQuestItemsCount(LOCKIRINS_NOTICE2_ID) == 0
            and st.getQuestItemsCount(MARIFES_REQUEST_ID) == 0
        ):
            ...
            and st.getInt("cond") >= 1
            and st.getQuestItemsCount(RING_OF_TESTIMONY1_ID) == 1
            and st.getQuestItemsCount(BLESSED_SEED_ID) == 0
        ):
            ...
            and st.getInt("cond") >= 1
            and st.getQuestItemsCount(RING_OF_TESTIMONY1_ID) == 1
            and st.getQuestItemsCount(BLESSED_SEED_ID) == 1
        ):
            ...
            and st.getInt("cond") >= 1
            and st.getQuestItemsCount(RING_OF_TESTIMONY1_ID) == 1
            and st.getQuestItemsCount(LILITH_ELVEN_WAFER_ID) == 0
            and st.getQuestItemsCount(CRYSTAL_BROOCH_ID) == 0
        ):
            ...
            and st.getInt("cond") >= 1
            and st.getQuestItemsCount(RING_OF_TESTIMONY1_ID) == 1
            and st.getQuestItemsCount(RECIPE_OF_EMILLY_ID) == 0
            and st.getQuestItemsCount(BRIGHTS_LIST_ID) == 0
            and st.getQuestItemsCount(MANDRAGORA_BOUQUET_ID) == 0
        ):
            ...
            and st.getQuestItemsCount(RECIPE_OF_EMILLY_ID) == 0
            and st.getQuestItemsCount(RING_OF_TESTIMONY1_ID)
            and st.getQuestItemsCount(BRIGHTS_LIST_ID)
        ):
            if (
                st.getQuestItemsCount(MANDRAGORA_PETAL_ID) < 20
                or st.getQuestItemsCount(CRIMSON_MOSS_ID) < 10
            ):
                htmltext = "30466-04.htm"
            else:
                htmltext = "30466-05.htm"
                st.takeItems(
                    MANDRAGORA_PETAL_ID, st.getQuestItemsCount(MANDRAGORA_PETAL_ID)
                )
            ...
            and st.getInt("cond") >= 1
            and st.getQuestItemsCount(RING_OF_TESTIMONY2_ID) == 1
            and st.getQuestItemsCount(CLAY_DOUGH_ID) == 0
            and st.getQuestItemsCount(PATTERN_OF_KEYHOLE_ID) == 0
            and st.getQuestItemsCount(NIKOLAS_LIST_ID) == 0
            and st.getQuestItemsCount(MAPHR_TABLET_FRAGMENT_ID) == 0
        ):
            ...
            and st.getInt("cond") >= 1
            and st.getQuestItemsCount(RING_OF_TESTIMONY2_ID)
            and st.getQuestItemsCount(CLAY_DOUGH_ID)
            and st.getQuestItemsCount(PATTERN_OF_KEYHOLE_ID) == 0
            and st.getQuestItemsCount(NIKOLAS_LIST_ID) == 0
            and st.getQuestItemsCount(MAPHR_TABLET_FRAGMENT_ID) == 0
        ):
            ...
            and st.getInt("cond") >= 1
            and st.getQuestItemsCount(RING_OF_TESTIMONY2_ID)
            and st.getQuestItemsCount(PATTERN_OF_KEYHOLE_ID)
            and st.getQuestItemsCount(CLAY_DOUGH_ID) == 0
            and st.getQuestItemsCount(NIKOLAS_LIST_ID) == 0
            and st.getQuestItemsCount(MAPHR_TABLET_FRAGMENT_ID) == 0
        ):
            ...
            and st.getInt("cond") >= 1
            and st.getQuestItemsCount(RING_OF_TESTIMONY2_ID)
            and st.getQuestItemsCount(NIKOLAS_LIST_ID)
            and st.getQuestItemsCount(CLAY_DOUGH_ID) == 0
            and st.getQuestItemsCount(PATTERN_OF_KEYHOLE_ID) == 0
            and st.getQuestItemsCount(MAPHR_TABLET_FRAGMENT_ID) == 0
            and st.getQuestItemsCount(KEY_OF_TITAN_ID) == 0
        ):
            ...
            and st.getQuestItemsCount(RING_OF_TESTIMONY2_ID)
            and st.getQuestItemsCount(NIKOLAS_LIST_ID)
            and st.getQuestItemsCount(KEY_OF_TITAN_ID)
            and st.getQuestItemsCount(CLAY_DOUGH_ID) == 0
            and st.getQuestItemsCount(PATTERN_OF_KEYHOLE_ID) == 0
            and st.getQuestItemsCount(MAPHR_TABLET_FRAGMENT_ID) == 0
        ):
    ...
    def onKill(self, npc, player, isPet):
        ...
        if npcId == 20223:
            ...
            if (
                st.getInt("cond")
                and st.getQuestItemsCount(RING_OF_TESTIMONY1_ID) == 1
                and st.getQuestItemsCount(CRIMSON_MOSS_ID) < 10
            ):
            ...
            if (
                st.getInt("cond")
                and st.getQuestItemsCount(RING_OF_TESTIMONY2_ID) == 1
                and st.getQuestItemsCount(STAKATO_SHELL_ID) < 20
            ):
            ...
            if (
                st.getInt("cond")
                and st.getQuestItemsCount(RING_OF_TESTIMONY2_ID) == 1
                and st.getQuestItemsCount(INPICIO_SAC_ID) < 10
            ):
                if st.getRandom(100) < 50:
            ...
            if (
                st.getInt("cond")
                and st.getQuestItemsCount(RING_OF_TESTIMONY2_ID) == 1
                and st.getQuestItemsCount(SPIDER_THORN_ID) < 10
            ):
                if st.getRandom(100) < 50:
