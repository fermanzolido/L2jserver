        ...
        if npcId == 30473:
            if st.getInt("cond") == 0 and st.getInt("onlyone") == 0:
                if st.getInt("cond") < 15:
                    if (
                        player.getClassId().getId() in [0x04, 0x0F, 0x1D, 0x13]
            ...
            if (
                st.getInt("cond") == 4
                and st.getQuestItemsCount(PICTURE_OF_WINDY) == 0
                and st.getQuestItemsCount(WINDYS_PEBBLES) == 0
                and st.getQuestItemsCount(GOLDEN_STATUE) == 0
            ):
