...
class Quest(JQuest):
    ...
    def onTalk(self, npc, player):
        ...
        if npcId == 30010 and st.getInt("cond") == 0:
            ...
            npcId == 30010
            and st.getInt("cond")
            and st.getQuestItemsCount(EINS_LETTER) > 0
        ):
            htmltext = "30010-07.htm"
        elif (
            npcId == 30010
            and st.getInt("cond")
            and st.getQuestItemsCount(WARRIOR_GUILD_MARK) == 1
        ):
            htmltext = "30010-08.htm"
        elif (
            npcId == 30253 and st.getInt("cond") and st.getQuestItemsCount(EINS_LETTER)
        ):
            htmltext = "30253-01.htm"
        elif (
            npcId == 30253
            and st.getInt("cond")
            and st.getQuestItemsCount(WARRIOR_GUILD_MARK)
        ):
            if st.getQuestItemsCount(RUSTED_BRONZE_SWORD1) < 1:
                ...
                st.takeItems(
                    RUSTED_BRONZE_SWORD1, st.getQuestItemsCount(RUSTED_BRONZE_SWORD1)
                )
            ...
            npcId == 30253
            and st.getInt("cond")
            and st.getQuestItemsCount(SIMPLONS_LETTER)
        ):
            ...
            and st.getInt("cond")
            and st.getQuestItemsCount(SIMPLONS_LETTER)
            and st.getQuestItemsCount(RUSTED_BRONZE_SWORD2)
            and st.getQuestItemsCount(WARRIOR_GUILD_MARK) == 0
            and st.getQuestItemsCount(EINS_LETTER) == 0
        ):
            ...
            npcId == 30010
            and st.getInt("cond")
            and st.getQuestItemsCount(RUSTED_BRONZE_SWORD3)
            and st.getQuestItemsCount(WARRIOR_GUILD_MARK) == 0
            and st.getQuestItemsCount(EINS_LETTER) == 0
        ):
            if st.getQuestItemsCount(POISON_SPIDER_LEG2) < 20:
                ...
                st.takeItems(
                    POISON_SPIDER_LEG2, st.getQuestItemsCount(POISON_SPIDER_LEG2)
                )
    ...
    def onKill(self, npc, player, isPet):
        ...
        if npcId in [20035, 20042]:
            ...
            if (
                st.getInt("cond") == 2
                and st.getQuestItemsCount(RUSTED_BRONZE_SWORD1) < 10
            ):
            ...
            if (
                st.getInt("cond")
                and st.getQuestItemsCount(POISON_SPIDER_LEG2) < 20
                and st.getQuestItemsCount(RUSTED_BRONZE_SWORD3) == 1
                and st.getItemEquipped(7) == RUSTED_BRONZE_SWORD3
            ):
