...
# ITEMS
TRUNK_OF_NEPENTHES, FOOT_OF_BANDERSNATCHLING, SECRET_SPICE, SAUCE = list(
    range(7202, 7206)
)
CRYOLITE = 7080
...
MOBS = (
    HOT_SPRINGS_ATROX,
    HOT_SPRINGS_ATROXSPAWN,
    HOT_SPRINGS_BANDERSNATCHLING,
    HOT_SPRINGS_NEPENTHES,
) = (21321, 21317, 21314, 21319)
ITEMS = {
