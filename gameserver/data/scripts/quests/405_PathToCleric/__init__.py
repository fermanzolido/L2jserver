...
class Quest(JQuest):
    ...
    def onEvent(self, event, st):
        ...
        if event == "1":
            ...
            if (
                level >= 19
                and classId == 0x0A
                and st.getQuestItemsCount(MARK_OF_FAITH) == 0
            ):
                st.set("cond", "1")
                st.setState(STARTED)
                ...
                level >= 19
                and classId == 0x0A
                and st.getQuestItemsCount(MARK_OF_FAITH) == 1
            ):
    ...
    def onTalk(self, npc, player):
        ...
        if npcId == 30022 and st.getInt("cond") == 0:
            ...
            npcId == 30022
            and st.getInt("cond")
            and st.getQuestItemsCount(LETTER_OF_ORDER2) == 1
            and st.getQuestItemsCount(LEMONIELLS_COVENANT) == 0
        ):
            ...
            and st.getInt("cond")
            and st.getQuestItemsCount(LETTER_OF_ORDER2) == 1
            and st.getQuestItemsCount(LEMONIELLS_COVENANT) == 1
        ):
            ...
            npcId == 30022
            and st.getInt("cond")
            and st.getQuestItemsCount(LETTER_OF_ORDER1) == 1
        ):
            if (
                st.getQuestItemsCount(BOOK_OF_VIVI) == 1
                and st.getQuestItemsCount(BOOK_OF_SIMLON) > 0
                and st.getQuestItemsCount(BOOK_OF_PRAGA) == 1
            ):
            ...
            if (
                st.getQuestItemsCount(BOOK_OF_PRAGA) == 0
                and st.getQuestItemsCount(NECKLACE_OF_MOTHER) == 0
            ):
                htmltext = "30333-01.htm"
                st.giveItems(NECKLACE_OF_MOTHER, 1)
            elif (
                st.getQuestItemsCount(BOOK_OF_PRAGA) == 0
                and st.getQuestItemsCount(NECKLACE_OF_MOTHER) == 1
                and st.getQuestItemsCount(PENDANT_OF_MOTHER) == 0
            ):
                htmltext = "30333-02.htm"
            elif (
                st.getQuestItemsCount(BOOK_OF_PRAGA) == 0
                and st.getQuestItemsCount(NECKLACE_OF_MOTHER) == 1
                and st.getQuestItemsCount(PENDANT_OF_MOTHER) == 1
            ):
            ...
            if st.getQuestItemsCount(LETTER_OF_ORDER2) == 0:
                ...
                st.getQuestItemsCount(LETTER_OF_ORDER2) == 1
                and st.getQuestItemsCount(BOOK_OF_LEMONIELL) == 0
                and st.getQuestItemsCount(LEMONIELLS_COVENANT) == 0
                and st.getQuestItemsCount(CERTIFICATE_OF_GALLINT) == 0
            ):
                ...
                st.getQuestItemsCount(LETTER_OF_ORDER2) == 1
                and st.getQuestItemsCount(BOOK_OF_LEMONIELL) == 1
                and st.getQuestItemsCount(LEMONIELLS_COVENANT) == 0
                and st.getQuestItemsCount(CERTIFICATE_OF_GALLINT) == 0
            ):
                ...
                and st.getQuestItemsCount(BOOK_OF_LEMONIELL) == 0
                and st.getQuestItemsCount(LEMONIELLS_COVENANT) == 0
                and st.getQuestItemsCount(CERTIFICATE_OF_GALLINT) == 1
            ):
            ...
            if (
                st.getQuestItemsCount(BOOK_OF_LEMONIELL) == 1
                and st.getQuestItemsCount(CERTIFICATE_OF_GALLINT) == 0
            ):
                ...
                st.getQuestItemsCount(BOOK_OF_LEMONIELL) == 0
                and st.getQuestItemsCount(CERTIFICATE_OF_GALLINT) == 1
            ):
