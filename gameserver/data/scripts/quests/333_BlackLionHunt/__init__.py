...
DROPLIST = {
    ...
    20781: [
        ...
        31,
        DELU_FANG,
    ],  # Delu Lizardman Shaman (not official Monster for this Quest)
    # Cruma Area - Part 4
...
p_redfoot = (
    html
    + sophia
    + 'Red foot  you may not like him much personally.  But he is the type of person who is missed when he is not around.  Although he is in charge of delivery of military supplies, he also works on the side as a broker of stolen war trophies and loot.  He is also a great source of information for our mercenary troops.  Since he brings with him quite a lot of useful information, stop by often to ask him questions.<br><a action="bypass -h Quest 333_BlackLionHunt p_trader_info">Ask about the traders union.</a><br><a action="bypass -h Quest 333_BlackLionHunt continue">Continue with your mission.</a><br><a action="bypass -h Quest 333_BlackLionHunt leave">Stop the mission you have been engaged in.</a>'
    + htmlend
)
p_no_items = (
    html
    + sophia
    + 'Dear brother of the Black Lion.  Dont you think that the place where you should be is not in this village but in the battlefield where the evil spirits are running wild!<br><a action="bypass -h Quest 333_BlackLionHunt continue">Continue with your mission.</a><br><a action="bypass -h Quest 333_BlackLionHunt leave">Stop the mission you have been engaged in.</a>'
    + htmlend
)
p_trader_info = (
    html
    + sophia
    + 'This cargo box definitely belongs to the Aden Traders Union. I can tell from the seal that is stamped on the box. If you want to return the cargo to them, go see Trader Union Member Morgan at the magic grocery store.  He works for the Aden Traders Union. <br><a action="bypass -h Quest 333_BlackLionHunt p_redfoot">Ask about Red Foot. </a><br><a action="bypass -h Quest 333_BlackLionHunt continue">Continue with your mission. </a><br><a action="bypass -h Quest 333_BlackLionHunt leave">Stop the mission you have been engaged in.</a>'
    + htmlend
)
p_both_info = (
    html
    + sophia
    + 'Dear brother.  I appreciate your hard work in carrying out the mission.  Ill give you your reward according to the number of proofs you have brought back.<br>What is that box?  It seems like you have brought back a cargo box that belongs to a traders union.  Since there is no clause regarding the returning of a cargo box written in our contract,  I guess we dont have the duty to return the cargo to the traders. But, if we return it to the traders union, perhaps they will give us some sort of reward?   If you dont feel like helping traders, you can go see Red Foot.   He is an expert in dealing with spoils that are hard to get rid of. <br><a action="bypass -h Quest 333_BlackLionHunt p_redfoot">Ask about Red Foot. </a><br><a action="bypass -h Quest 333_BlackLionHunt p_trader_info">Ask about the traders union.</a><br> <a action="bypass -h Quest 333_BlackLionHunt continue">Continue with your mission.</a><br><a action="bypass -h Quest 333_BlackLionHunt leave">Stop the mission you have been engaged in.</a>'
    + htmlend
)
p_only_item_info = (
    html
    + sophia
    + 'Dear brother.  I appreciate your hard work in carrying out the mission. Ill give you your reward according to the number of proofs you have brought back.<br><a action="bypass -h Quest 333_BlackLionHunt continue">Continue to carry out the mission.</a><br><a action="bypass -h Quest 333_BlackLionHunt leave">Stop the mission you have been engaged in.</a>'
    + htmlend
)
p_leave_mission = (
    html
    + sophia
    + 'I appreciate your hard work so far.  Even a lion needs a break.   Retire to the village and replenish your energy while resting there.  Maintaining ones own physical strength is one of the basic skills of being a mercenary.<br><a action="bypass -h Quest 333_BlackLionHunt start_chose_parts">Tell him that you would like to take on a new mission.</a><br><a action="bypass -h Quest 333_BlackLionHunt r_exit">Leave the mercenary troop.</a>'
    + htmlend
)
p_only_box_info = (
    html
...
r_exit = (
    html
    + sophia
    + 'What?!  You want to leave the Black Lion troop?  Well, I guess you must have your own reasons.  I wont ask about that  However, Ill tell you one thing  The only place for someone like yourself who was born with the blood of a fighter is in a mercenary troop.  No matter where you go, you are destined to end up on the battlefield.<br>Anyhow, if you really want to withdraw from the mercenary troop, bear this in mind.  Upon your departure, you will have to return the Black Lion Mark.  Also, according to your contributions of service you have achieved so far, you will receive the proper discharge pay.<br><a action="bypass -h Quest 333_BlackLionHunt continue">Continue to work for the mercenary troop.</a><br><a action="bypass -h Quest 333_BlackLionHunt exit">Leave the mercenary troop.</a>'
    + htmlend
)
exit = (
    html
    + sophia
    + "If you really have already made up your mind, I will not hold you back any more.  Please return the Black Lion Mark.  I regret that our relationship as comrades will end from here on.  Oh, take this before you go.  This is the reward for your services you have earned until now for the mercenary troop.  Wherever you go, you can use it as seed money to establish yourself in a new place.  Well, until the day when we draw our swords together again.  Good luck brother!"
    + htmlend
)
# -Start
start_error1 = (
    html
    + sophia
    + "As I said before, our current mission is to drive out the evil spirits in this area.  However, since the main force of the mercenary troop has been dispatched to Gludio, our military force is suffering a shortage.  The only thing we are managing to do right now is to contain the evil spirits from attacking the village.  Even now, if I can find some tough skinned fighters, I am willing to hire them right away to supplement our force!<br>(This is a quest that can be carried out by a character of level 25 or above and in possession of the Black Lion Mark.)"
    + htmlend
)
start_error2 = (
    html
...
start_start = (
    html
    + sophia
    + 'Dear brother of the Black Lion.  Our current situation is as follows.  As I said before, our current mission is to drive out the evil spirits in this area.  However, since the main force of the mercenary troop has been dispatched to Gludio, our military force is suffering a shortage.  The only thing we are managing to do right now is to contain the evil spirits from attacking the village. <br>Fortunately, Captain Leopold of Gludin has sent many newly selected mercenary brothers.  So we can launch our attack on the stronghold of the evil spirits in earnest.  Brother, I would like you to join us in this fight.<br><a action="bypass -h Quest 333_BlackLionHunt start">Tell him that you will join them in the fight.</a>'
    + htmlend
)
start_explain = (
    html
    + sophia
    + 'All right!  The time has come for the black lions that have been crouching until now, to bare their claws and start hunting!<br>Now, I will explain our combat situation.  We currently have four targets of attack.  They are the Execution Ground, the Partisan Hideaway, southern shoreline area, and the Cruma Marshlands.  Since we do not have enough combat power to hold a drawn-out war, we will dispatch a small group of soldiers as a strike force to carry out the strategy of hit and run to drive out the evil spirits.<br><a action="bypass -h Quest 333_BlackLionHunt start_parts">Listen to the mission of each area.</a>'
    + htmlend
)
start_parts = (
    html
    + sophia
    + 'About which mission would you like to hear about?<br><br><a action="bypass -h Quest 333_BlackLionHunt p1_explanation">Clean out the undead in the Execution Ground.</a><br><a action="bypass -h Quest 333_BlackLionHunt p2_explanation">Drive out the ol mahum in the Partisan Hideaway.</a><br><a action="bypass -h Quest 333_BlackLionHunt p3_explanation">Drive out the delu lizardman in the southern shore area.</a><br><a action="bypass -h Quest 333_BlackLionHunt p4_explanation">Smash the marsh stakato in the Cruma Marshlands.</a>'
    + htmlend
)
start_ask_again = (
    html
    + sophia
    + 'Dear Black Lion brother, the war with the evil spirits has already started! Dont you think you should be active in this fight with us?<br><a action="bypass -h Quest 333_BlackLionHunt start_parts">Listen to the explanation about the mission.</a>'
    + htmlend
)
start_continue = (
    html
    + sophia
    + "Hurry!  Rush to the battlefield, destroy your enemies and taste the sweetness of victory!"
    + htmlend
)
# -Part 1
p1_explanation = (
    html
    + sophia
    + 'The Execution Ground is located in the eastern part of the village. It is an eerie place where people can hear the never ending cries of dead souls. Your mission is to clean out the undead that are infesting the place. According to a rumor, in order to pay for the spilled blood of innocent people who were killed during the farmers uprising, the undead came back to this world Well, all I know is that we need to carry out the given assignment. Still, I dont feel good about this for some reason. <br><a action="bypass -h Quest 333_BlackLionHunt p1_t">Take on the mission.</a><br><a action="bypass -h Quest 333_BlackLionHunt start_chose_parts">Listen to the explanation about another mission.</a>'
    + htmlend
)
p1_take = (
    html
    + sophia
    + 'The undead that we need to drive out are <font color="LEVEL">specters, sorrow maiden, neer crawlers, neer ghoul berserker, strains and ghouls</font>. I dont know whether you know about this or not.  But when an undead is destroyed, it leaves behind a handful of ashes.  Bring me back that as proof of victory.  The more <font color="LEVEL">ashes of undead </font> you bring, the more rewards you will receive.  Since you once worked under Captain Leopold, you already know the rule about proofs and rewards, dont you?  <br> Now then, hurry up.  Prepare yourself for combat and leave for the Execution Ground immediately. Prove to everybody the fact that even the undead who have been resurrected from the dungeon of purgatory will not be a match for us the Black Lion troop!'
    + htmlend
)
# -Part 2
p2_explanation = (
    html
    + sophia
    + 'This mission is to drive out the remnants of the Grecian military force that is currently encamped in the northwestern part of  the Horseshoe Valley.  Dont take them too lightly by thinking that they are mere rabble of defeated soldiers.    Your opponents are ol mahums of the Bloody Axe army led by the Blood Lord Nurka.  They are a formidable enemy that you shouldnt take too lightly.<br><a action="bypass -h Quest 333_BlackLionHunt p2_t">Take on the mission.<\a> <br> <a action="bypass -h Quest 333_BlackLionHunt start_chose_parts">Listen to the explanation about another mission.</a>'
    + htmlend
)
p2_take = (
    html
    + sophia
    + 'The enemies that you will have to defeat are <font color="LEVEL">ol mahum guerillas, ol mahum raiders, ol mahum marksman, ol mahum sergeants and ol mahum captains</font>.<br>As a proof that you have defeated the enemy, bring me back the <font color="LEVEL">bloodyaxe insignia</font> the symbol of the partisan army.  The more proofs you bring, the greater your reward will be.  Well, since you once worked under Captain Leopold, you already know the rule about proofs and rewards, dont you?<br>Now then, hurry up and leave for the Partisan Hideaway. Show them the wrath of the Black Lion troop to those rampaging ol mahums!'
    + htmlend
)
# -Part 3
p3_explanation = (
    html
    + sophia
    + 'The headquarters of delu lizardmen was originally located at the shore area in the southern part of Giran.  However, lately, many of them are infiltrating into Dion territory.  We dont know yet whether they are entering Dion just to find food or to prepare some large scale invasion.  But what is clear is that they are making their movements with some clear goal.  Our mission is to smash their units one by one and instill fear in them thereby discouraging them from settling down in this area.<br><a action="bypass -h Quest 333_BlackLionHunt p3_t">Take on the mission.</a> <br> <a action="bypass -h Quest 333_BlackLionHunt start_chose_parts">Listen to the explanation about another mission.</a>'
    + htmlend
)
p3_take = (
    html
    + sophia
    + 'The enemies that you will deal with are <font color="LEVEL">Delu Lizardmen, Delu Lizardman Scouts and Delu Lizardman Warriors</font>. As a proof that you slayed them, bring back the <font color="LEVEL">Delu Lizardmens\' Teeth</font>. But be careful.  Comparing with the felim tribe in Gludio or langk lizardman, they are much more violent and hostile.<br>The more proofs of victory you bring, the greater your reward will be.  Well, since you once worked under Captain Leopold, you should already know the rule about proofs and rewards, dont you? <br>Well then, leave for the battleground.  Trample down and destroy those lizards that are running amok without knowing their proper place!'
    + htmlend
)
# -Part 4
p4_explanation = (
...
f_no_box = (
    html
    + redfoot
    + 'Hey brother!  Did you tell me that youre currently on active duty?  I know that must be hard work!  Is there anything I can help you with?<br><a action="bypass -h Quest 333_BlackLionHunt f_info">Ask whether he has any useful information.</a>'
    + htmlend
)
f_give_box = (
    html
    + redfoot
    + 'Hey brother!  Did you tell me that youre currently on active duty?  I know that must be hard work!  Is there anything I can help you with?<br>What kind of box is that?  Oh, I know.  Thats a cargo box used by traders.  Since you brought it to me  I can assume that you dont have any intention of returning it to the merchant, am I right?  All right.  Ill open the box for you.  Of course, you can have the contents of the box.  Instead, Ill charge you a small fee.  I think <font color="LEVEL">650 adena</font> will be appropriate.  Think of it as the price for opening the box and for keeping my mouth shut.<br><a action="bypass -h Quest 333_BlackLionHunt f_give">Ask him to open the box for you.</a><br>'
    + back
    + htmlend
)
f_rnd_list = [
...
f_no_news = (
    html
    + redfoot
    + "Sorry.  I dont have any new information for you.  Why dont you stop by again later.<br>"
    + back
    + htmlend
)
f_more_help = (
    html
    + redfoot
    + 'Is there anything else I can help you with?<br><a action="bypass -h Quest 333_BlackLionHunt f_give">Ask him to open the box for you.</a>'
    + htmlend
)
f_no_more_box = (
    html
    + redfoot
    + 'I dont know what to say to you!  You dont even have a Cargo Box with you.  But are you still asking me to open one?<br><br><a action="bypass -h Quest 333_BlackLionHunt f_info">Ask whether he has any useful information.</a>'
    + htmlend
)
f_more_help2 = (
    html
    + redfoot
    + 'Is there anything else you would like me to help you with?<br><a action="bypass -h Quest 333_BlackLionHunt f_give">Ask him to open the cargo box for you.</a><br><a action="bypass -h Quest 333_BlackLionHunt f_info">Ask him whether he has any useful information for you.</a>'
    + htmlend
)
f_not_adena = (
    html
    + redfoot
    + "Listen here brother!  This is not enough money!!!  You didnt think by any chance that I would give out the information to you for free, did you?  This is business for me too, understand!<br>"
    + back
    + htmlend
)
# Rupio
...
r_no_items = (
    html
    + rupio
    + "Are you a Black Lion mercenary? What's the reason for visiting our blacksmith shop...? Have you come to have a weapon made?"
    + htmlend
)
r_items = (
    html
    + rupio
    + 'What can I help with?<br><a action="bypass -h Quest 333_BlackLionHunt r_give_statue">Ask to put together pieces of statue.</a><br><a action="bypass -h Quest 333_BlackLionHunt r_give_tablet">Ask to put together stone tablet.'
    + htmlend
)
r_statue_pieces = (
    html
    + rupio
    + "How did you know that my hobby was relic restoration? But to restore a stone item to its original condition, you can't be missing even one piece. If you want me to put the statue of the goddess back together, you'll need all the pieces, which are <font color=\"LEVEL\">head, torso, arms and legs</font>), right?"
    + htmlend
)
r_statue_brockes = (
    html
    + rupio
    + "OK, shall I demonstrate my talents now? First... Attach the legs to the base... Then the torso above that... And if we match the joints of the arms and head properly... Huh? The statue just crumbled... I knew that it was really old and the material weak but.. When I just applied some pressure to connect... Oh, I'm really sorry."
    + htmlend
)
r_statue_complete = (
    html
    + rupio
    + "OK, shall I demonstrate my talents now? First... Attach the legs to the base... Then the torso above that... And if we match the joints of the arms and head properly... OK! It's finished! The joints of the connecting parts are still visible but overall, it looks perfect, don't you think? Hmm... Is it the image of the goddess of Shilen? Looking at it carefully, it's really a beautiful statue."
    + htmlend
)
r_tablet_pieces = (
    html
    + rupio
    + "How did you know that my hobby was relic restoration? But with relics like tablets on which words are written, we can't read them if there is even one piece missing and so there's really no point in just putting the other pieces together. In my experience, square-shaped relics like stone tablets often break into <font color=\"LEVEL\">four pieces</font>."
    + htmlend
)
r_tablet_brockes = (
    html
    + rupio
    + "OK, shall I demonstrate my talents now? Well, this fragment looks like it goes to the very bottom section of the stone tablet... And this piece is above that... Oh! The tablet just crumbled... I should have expected that the material would be really weak from having been exposed to the rain and wind for such a long time... Darn...! I'm really sorry for making such a big mistake."
    + htmlend
)
r_tablet_complete = (
    html
    + rupio
    + "OK, shall I demonstrate my talents now? Well, this fragment looks like it goes to the very bottom section of the stone tablet... And this piece is above that... It's like putting together a puzzle... OK... It's finished! It's an ancient stone tablet... I'm really curious whether some secrets of history are recorded on it! Hmm... But these letters look like writing of the titans... I've seen this somewhere before...! Where in the world could...?!"
    + htmlend
)
# Lockirin
...
l_no_tablet = (
    html
    + lockirin
    + "I'm extremely interested in the civilization of the titans. In particular, I'd pay any amount to hold in my hands a clay tablet on which the titan writing is written.  If I was some high-class person such as yourself, I might have seen such a thing as that. They say that ancient clay tablets are often found in the Dion region..."
    + htmlend
)
l_just_pieces = (
    html
    + lockirin
    + "This clay tablet... Where in the world could...?! It's just one part, but... Maphr...!<br> Look at this, young fellow! Where in the world did you find this? If you can gather the other pieces too and assemble them into a single item, I'll give you something great in gratitude! I promise in the name of the first elder of the guild federation!"
    + htmlend
)
l_tablet = (
    html
    + lockirin
    + 'This clay tablet... Where in the world could...?! It\'s just one part, but... Maphr...!  Where did such a precious thing...? Look at this, young fellow! I\'ll present to you a big gift of gratitude so please give this tablet to me!<br><a action="bypass -h Quest 333_BlackLionHunt l_give">Hand over clay tablet.</a><br><a action="bypass -h Quest 333_BlackLionHunt l_info">Don\'t hand over.'
    + htmlend
)
l_give = (
    html
    + lockirin
    + "I'm really thankful! Finally the deep-rooted work of our guild federation...! Here, take this gift of gratitude! And if you find more of these clay tablets in the future, please bring those to me also! I'll express my thanks adequately!"
    + htmlend
)
l_info = (
    html
    + lockirin
    + "Huh...?! I said I'd express my thanks abundantly but you still refuse... Look here, young fellow. Do you really think you can sell that tablet somewhere else at a higher price? I guarantee that no matter how hard you look, you won't find anyone that will give you as much as I will. If your opinion changes, please come to me again. Turn over that tablet to me anytime and I'll give you a big gift of gratitude as I promised!"
    + htmlend
)
# Undiras
        ...
        if event == "start":
            ...
            if claw:
                ...
                while claw > 0:
                    ...
                    if n < 1:
                        st.giveItems(
                            ALACRITY_POTION, int(ala_count * Config.RATE_QUESTS_REWARD)
                        )
                    elif n < 2:
                        st.giveItems(
                            SOULSHOT_D, int(soul_count * Config.RATE_QUESTS_REWARD)
                        )
                    elif n < 3:
                        st.giveItems(
                            SCROLL_ESCAPE, int(soe_count * Config.RATE_QUESTS_REWARD)
                        )
                    elif n < 4:
                        st.giveItems(
                            SPIRITSHOT_D, int(spir_count * Config.RATE_QUESTS_REWARD)
                        )
                    elif n == 4:
                        st.giveItems(
                            HEALING_POTION, int(heal_count * Config.RATE_QUESTS_REWARD)
                        )
                    claw -= 1
                if check_eye:
                    return p_eye
                ...
                if st.getQuestItemsCount(ADENA_ID) >= OPEN_BOX_PRICE:
                    ...
                    if random < 21:
                        ...
                        return (
                            ...
                            + redfoot
                            + standart
                            + "<br>Fruit?  Oh, they must be apples grown in Gludio!  Mmm they look delicious.  If you take them to the market before they go bad, I guess you will be able to make some money.<br>"
                            + back
                            + htmlend
                        )
                    elif random < 41:
                        ...
                        return (
                            ...
                            + redfoot
                            + standart
                            + "Isnt this corn meal?  Isnt this used to feed pigs?  Well, anyhow, since its not anything you can use for yourself, you should take it to the market to sell it.<br>"
                            + back
                            + htmlend
                        )
                    elif random < 61:
                        ...
                        return (
                            ...
                            + redfoot
                            + standart
                            + "<br>Whats this pelts?  Dire Wolf Pelts?  They seem to have been tanned by a leather craftman. But they are not of high quality.  Maybe they can be used to make leather hats?  Well, anyhow, if you take them to the market, you will get some money for them.<br>"
                            + back
                            + htmlend
                        )
                    elif random < 74:
                        ...
                        return (
                            ...
                            + redfoot
                            + standart
                            + "<br>A gem?  Oh wow, a Moonstone!  You should be able to sell it at a fairly good price.<br>"
                            + back
                            + htmlend
                        )
                    elif random < 86:
                        st.giveItems(
                            GLUDIO_WEETS_FLOWER, int(Config.RATE_QUESTS_REWARD)
                        )
                        return (
                            html
                            + redfoot
                            + standart
                            + "<br>Hmm?  Whats this powder?  Should I taste it?   Yes, this must be Gludio Wheat Flour!  It can be used for baking bread I guess.   Well, anyhow, you should be able to sell it for a decent price at the market.<br>"
                            + back
                            + htmlend
                        )
                    elif random < 98:
                        ...
                        return (
                            ...
                            + redfoot
                            + standart
                            + "Whats this?  Its Spidersilk Rope!  Its a very strong and light rope that is made from the spidersilk that is collected from the Tarantula Spiders webs in the Spine Mountain Range.  If you take it to a store, Im sure you should be able to get a really good price for it.<br>"
                            + back
                            + htmlend
                        )
                    elif random < 99:
                        ...
                        return (
                            ...
                            + redfoot
                            + standart
                            + "Hmm?  A silver bowl?  And a teacup?  They seem to be of pretty high quality!  It seems like they were made by elven artisans.  I am not interested in such exquisite items but, anyway, if you take them to a store, you should be able to sell them for a fairly good price.<br>"
                            + back
                            + htmlend
                        )
                    elif random < 119:
                        ...
                        return (
                            ...
                            + redfoot
                            + standart
                            + "Hmm?  Machine parts?  This Guild Mark seems to be that of the Black Anvil Guild what do you think?  Although I dont know for sure, these seem to be parts that are used by dwarves to do repair work on golems.  If you take them to a store, I think you will be able to sell them at a pretty reasonable price.<br>"
                            + back
                            + htmlend
                        )
                    elif random < 123:
                        ...
                        return (
                            ...
                            + redfoot
                            + standart
                            + "Whats this gem?  Ah!  Its a Fire Emerald!  Dont you know about it?  its a rare and precious gemstone that gives out a strong red light when its exposed to sun light.  You are so lucky!  You can take it to a store and sell it at a very high price.<br>"
                            + back
                            + htmlend
                        )
                    elif random < 127:
                        ...
                        return (
                            ...
                            + redfoot
                            + standart
                            + "Isnt this a dress?!  This is a silk dress for a woman.  It looks pretty expensive, dont you think?  Take a look at this design.  This is an item that has been imported from Avella of the East.  At a time like this, who would use such a luxurious item?  This must be ordered by a noblewoman who has a liking for foreign products dont you think?  You should take this to a store and sell it off!  Im sure you will get a very high price for it.<br>"
                            + back
                            + htmlend
                        )
                    elif random < 131:
                        ...
                        return (
                            ...
                            + redfoot
                            + standart
                            + "Hmm?  Dont tell me!  I dont believe it!!!  Wow, an Imperial Diamond?  Isnt this the one that was used to decorate the crown of the king of Elmo-Aden?  Its truly beautiful!   You are extremely lucky!  You got yourself a priceless item.  If you take it to the market, Im sure you will be able to get a huge amount of money for it.<br>"
                            + back
                            + htmlend
                        )
                    elif random < 147:
