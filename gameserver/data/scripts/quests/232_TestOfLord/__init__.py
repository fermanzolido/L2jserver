            ...
            if st.getInt("phase") == 1:
                ...
                #             Duda Part
                    ...
                    if duda == 0:
                        ...
                        st.takeItems(
                            MARSH_SPIDER_FEET, st.getQuestItemsCount(MARSH_SPIDER_FEET)
                        )
    ...
    def onKill(self, npc, player, isPet):
        ...
        if item == MARSH_SPIDER_FEELER and int(st.get(var)) == value:
            ...
            if count == maxcount - 1:
                ...
                if (
                    newValue == 1
                    and st.getQuestItemsCount(RAGNA_ORC_HEAD)
                    and st.getQuestItemsCount(RAGNA_CHIEF_NOTICE)
                ):
                    st.set(var, "2")
                else:
