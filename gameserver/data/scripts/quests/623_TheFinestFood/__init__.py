...
DROPLIST = {
    BUFFALO: [BUFFALO_MEAT, 99],
    FLAVA: [LEAF_OF_FLAVA, 99],
    ANTELOPE: [ANTELOPE_HORN, 99],
}
REWARDS = [
    [6849, 25000, 0, 11],
    [6847, 65000, 12, 23],
            ...
            if st.getState() == STARTED:
                ...
                if st.getInt("cond") == 1 and count < 100:
                    ...
                    if numItems != 0:
                        ...
                        if (
                            st.getQuestItemsCount(LEAF_OF_FLAVA)
                            == st.getQuestItemsCount(BUFFALO_MEAT)
                            == st.getQuestItemsCount(ANTELOPE_HORN)
                            == 100
                        ):
                            st.set("cond", "2")
