        ...
        if npcId == 30307 and st.getInt("cond") == 0 and st.getInt("onlyone") == 0:
            ...
            if (
                ...
                and (
                    ...
                    or st.getQuestItemsCount(CECKTINONS_VOUCHER1_ID) >= 1
                    or st.getQuestItemsCount(CECKTINONS_VOUCHER2_ID) >= 1
                )
            ):
                ...
                npcId == 30132
                and st.getInt("cond") == 1
                and st.getQuestItemsCount(KAROYDS_LETTER_ID) == 1
            ):
                ...
                npcId == 30144
                and st.getInt("cond") == 2
                and st.getQuestItemsCount(CECKTINONS_VOUCHER1_ID) >= 1
            ):
                ...
                and st.getQuestItemsCount(CECKTINONS_VOUCHER2_ID) >= 1
                and st.getQuestItemsCount(BONE_FRAGMENT1_ID) < 10
            ):
                ...
                and st.getQuestItemsCount(SOUL_CATCHER_ID) == 1
            ):
                ...
                and st.getQuestItemsCount(PRESERVE_OIL_ID) == 1
                and st.getQuestItemsCount(ZOMBIE_HEAD_ID) == 0
                and st.getQuestItemsCount(STEELBENDERS_HEAD_ID) == 0
            ):
                htmltext = "30132-04.htm"
            elif (
                npcId == 30132
                and st.getInt("cond") == 7
                and st.getQuestItemsCount(ZOMBIE_HEAD_ID) == 1
            ):
                ...
                and st.getQuestItemsCount(STEELBENDERS_HEAD_ID) == 1
            ):
