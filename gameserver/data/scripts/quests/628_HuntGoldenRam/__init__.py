...
class Quest(JQuest):
    ...
    def onAdvEvent(self, event, npc, player):
        ...
        ):  # Giving 100 Splinter Stakato Chitins. Getting Recruit mark
            ...
            if cond == 0:  # Starting the quest
                ...
                if cond == 1:  # Bringin Splinter Stakato chitins
                    ...
                    if npcId == SELINA:  # Buffer: not qualified
                        ...
                        chitin1 >= count and chitin2 >= count
                    ):  # Enough chitins. Ending the quest, Soldier mark.
                        ...
                        not chitin1 and not chitin2
                    ):  # Have no chitins. Can stop the quest
