    ...
    def onTalk(self, npc, player):
        ...
        if id == STARTED:
            if (
                ...
                and (
                    st.getQuestItemsCount(FOX_FUR_YARN_ID) == 0
                    and st.getQuestItemsCount(MAIDEN_DOLL_ID) == 0
                )
                and st.getQuestItemsCount(FOX_FUR_ID) < 10
            ):
                ...
                and st.getInt("cond") == 1
                and st.getQuestItemsCount(FOX_FUR_ID) < 10
                and st.getQuestItemsCount(FOX_FUR_ID) > 0
            ):
                ...
                and st.getInt("cond") == 1
                and st.getQuestItemsCount(FOX_FUR_ID) >= 10
                and st.getQuestItemsCount(FOX_FUR_YARN_ID) == 0
                and st.getQuestItemsCount(MAIDEN_DOLL_ID) == 0
                and st.getQuestItemsCount(MAIDEN_DOLL_ID) < 10
            ):
                ...
                npcId == 30051
                and st.getInt("cond") == 1
                and st.getQuestItemsCount(FOX_FUR_YARN_ID) >= 1
            ):
                htmltext = "30051-03.htm"
            elif (
                npcId == 30051
                and st.getInt("cond") == 1
                and st.getQuestItemsCount(MAIDEN_DOLL_ID) == 1
            ):
