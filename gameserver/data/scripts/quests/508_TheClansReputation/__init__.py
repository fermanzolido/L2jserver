...
NUCLEUS_OF_FLAMESTONE_GIANT = (
    8494  # Nucleus of Flamestone Giant : Nucleus obtained by defeating Flamestone Giant
)
THEMIS_SCALE = (
    8277  # Themis' Scale : Obtain this scale by defeating Palibati Queen Themis.
)
NUCLEUS_OF_HEKATON_PRIME = (
    8279  # Nucleus of Hekaton Prime : Nucleus obtained by defeating Hekaton Prime
)
TIPHON_SHARD = (
    8280  # Tiphon Shard : Debris obtained by defeating Tiphon, Gargoyle Lord.
)
