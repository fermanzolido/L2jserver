...
class Quest(JQuest):
    ...
    def onAdvEvent(self, event, npc, player):
        ...
        if event == "31522-02.htm":
            ...
            htmltext = (
                "Congratulations! You are completed this quest!"
            ...
            if event == "1":
                npc.getAI().setIntention(
                    CtrlIntention.AI_INTENTION_MOVE_TO, L2CharPosition(x, y, z, heading)
                )
    ...
    def onTalk(self, npc, player):
        ...
        if npcId == 31522:
            ...
            if cond == 6:
                ...
                if (
                    st.getInt("AGRIPEL") == 1
                    and st.getInt("DOMINIC") == 1
                    and st.getInt("BENEDICT") == 1
                ):
