        ...
        if npcId == Grey:
            ...
            if not bracelet_1 and not bracelet_2:
                ...
                if not st.getQuestItemsCount(Cyb_Req):
                    ...
                    st.getQuestItemsCount(3699)
                    or st.getQuestItemsCount(3700)
                    or st.getQuestItemsCount(3701)
                    or st.getQuestItemsCount(3702)
                    or st.getQuestItemsCount(3703)
                    or st.getQuestItemsCount(3704)
                    or st.getQuestItemsCount(3705)
                    or st.getQuestItemsCount(3706)
                ):
                    htmltext = "06"
                else:
                    htmltext = "10"
    ...
    def onKill(self, npc, player, isPet):
        ...
        if cond == 1 and instructions_1:
            ...
            if instructions_2:
                ...
                if (
                    rand < chance
                    and st.getQuestItemsCount(req)
                    and st.getQuestItemsCount(give) < amount
                ):
        ...
        if (
            ...
            and player.getActiveWeaponItem().getItemId() == Cyb_Dagger
            and st.getQuestItemsCount(Cyb_Req)
            and not st.getQuestItemsCount(3708)
        ):
            if Rnd.get(2):
                if cond == 2 or cond == 3:
