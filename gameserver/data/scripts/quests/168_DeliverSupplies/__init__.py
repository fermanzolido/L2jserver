...
class Quest(JQuest):
    ...
    def onTalk(self, npc, player):
        ...
        if npcId == 30349 and st.getInt("cond") == 0 and st.getInt("onlyone") == 0:
            ...
            and st.getQuestItemsCount(JENNIES_LETTER_ID)
        ):
            htmltext = "30349-04.htm"
        elif (
            npcId == 30349
            and st.getInt("cond") == 1
            and st.getQuestItemsCount(SENTRY_BLADE1_ID) == 1
            and st.getQuestItemsCount(SENTRY_BLADE2_ID) == 1
            and st.getQuestItemsCount(SENTRY_BLADE3_ID) == 1
        ):
            ...
            npcId == 30349
            and st.getInt("cond") == 1
            and st.getQuestItemsCount(SENTRY_BLADE1_ID) == 0
            and (
                st.getQuestItemsCount(SENTRY_BLADE2_ID) == 1
                or st.getQuestItemsCount(SENTRY_BLADE3_ID) == 1
            )
        ):
            ...
            npcId == 30349
            and st.getInt("cond") == 1
            and st.getQuestItemsCount(OLD_BRONZE_SWORD_ID) == 2
            ...
            if (
                npcId == 30360
                and st.getInt("cond") == 1
                and st.getQuestItemsCount(JENNIES_LETTER_ID) == 1
            ):
                ...
                and st.getInt("cond") == 1
                and (
                    st.getQuestItemsCount(SENTRY_BLADE1_ID)
                    + st.getQuestItemsCount(SENTRY_BLADE2_ID)
                    + st.getQuestItemsCount(SENTRY_BLADE3_ID)
                )
                > 0
            ):
                ...
                npcId == 30355
                and st.getInt("cond") == 1
                and st.getQuestItemsCount(SENTRY_BLADE2_ID) == 0
            ):
                ...
                npcId == 30357
                and st.getInt("cond") == 1
                and st.getQuestItemsCount(SENTRY_BLADE3_ID) == 0
            ):
