...
class Quest(JQuest):
    ...
    def onTalk(self, npc, player):
        ...
        if npcId == 30648 and cond == 0 and id == CREATED:
            ...
            npcId == 30571 and cond in [5, 6] and st.getQuestItemsCount(SPIRIT_OF_FLAME)
        ):
            ...
            npcId == 30650
            and cond >= 9
            and st.getQuestItemsCount(GREY_BADGE)
            and st.getQuestItemsCount(BOOK_OF_GERALD)
        ):
            ...
            npcId == 30036 and cond == 12 and st.getQuestItemsCount(STATUE_OF_EINHASAD)
        ):
            ...
            npcId == 30362
            and cond == 15
            and st.getQuestItemsCount(BOOK_OF_DARKNESS) == 0
        ):
