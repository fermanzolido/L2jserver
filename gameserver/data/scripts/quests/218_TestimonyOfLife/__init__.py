...
class Quest(JQuest):
    ...
    def onEvent(self, event, st):
        ...
        if event == "1":
            ...
            st.takeItems(
                PURE_MITHRIL_ORE_ID, st.getQuestItemsCount(PURE_MITHRIL_ORE_ID)
            )
            st.takeItems(
                ANT_SOLDIER_ACID_ID, st.getQuestItemsCount(ANT_SOLDIER_ACID_ID)
            )
    ...
    def onTalk(self, npc, player):
        ...
        if npcId == 30460 and st.getInt("cond") == 0 and st.getInt("onlyone") == 0:
            ...
            and st.getQuestItemsCount(CARDIENS_LETTER_ID) == 1
        ):
            htmltext = "30460-05.htm"
        elif (
            npcId == 30460
            and st.getInt("cond") == 1
            and st.getQuestItemsCount(MOONFLOWER_CHARM_ID) == 1
        ):
            htmltext = "30460-06.htm"
        elif (
            npcId == 30460
            and st.getInt("cond") == 1
            and st.getQuestItemsCount(CAMOMILE_CHARM_ID) == 1
        ):
            ...
            and st.getInt("cond") == 1
            and st.getQuestItemsCount(MOONFLOWER_CHARM_ID) == 1
            and st.getQuestItemsCount(WATER_OF_LIFE_ID) == 0
        ):
            htmltext = "30154-08.htm"
        elif (
            npcId == 30154
            and st.getInt("cond") == 1
            and st.getQuestItemsCount(MOONFLOWER_CHARM_ID)
            and st.getQuestItemsCount(WATER_OF_LIFE_ID)
        ):
            ...
            and st.getInt("cond") == 1
            and st.getQuestItemsCount(MOONFLOWER_CHARM_ID)
            and st.getQuestItemsCount(HIERARCHS_LETTER_ID)
        ):
            ...
            and st.getInt("cond") == 1
            and st.getQuestItemsCount(MOONFLOWER_CHARM_ID)
            and st.getQuestItemsCount(GRAIL_DIAGRAM_ID)
        ):
            ...
            and st.getInt("cond") == 1
            and st.getQuestItemsCount(MOONFLOWER_CHARM_ID)
            and st.getQuestItemsCount(PUSHKINS_LIST_ID)
        ):
            ...
            and st.getInt("cond") == 1
            and st.getQuestItemsCount(MOONFLOWER_CHARM_ID)
            and st.getQuestItemsCount(PURE_MITHRIL_CUP_ID)
        ):
            ...
            and st.getInt("cond") == 1
            and st.getQuestItemsCount(MOONFLOWER_CHARM_ID)
            and st.getQuestItemsCount(THALIAS_LETTER1_ID)
        ):
            ...
            and st.getInt("cond") == 1
            and st.getQuestItemsCount(MOONFLOWER_CHARM_ID)
            and st.getQuestItemsCount(ARKENIAS_CONTRACT_ID)
        ):
            ...
            and st.getInt("cond") == 1
            and st.getQuestItemsCount(MOONFLOWER_CHARM_ID)
            and st.getQuestItemsCount(STARDUST_ID)
        ):
            ...
            and st.getInt("cond") == 1
            and st.getQuestItemsCount(MOONFLOWER_CHARM_ID)
            and st.getQuestItemsCount(THALIAS_INSTRUCTIONS_ID)
        ):
            ...
            and st.getInt("cond") == 1
            and st.getQuestItemsCount(MOONFLOWER_CHARM_ID)
            and st.getQuestItemsCount(THALIAS_LETTER2_ID)
        ):
            ...
            and st.getInt("cond") == 1
            and st.getQuestItemsCount(MOONFLOWER_CHARM_ID)
            and st.getQuestItemsCount(ISAELS_INSTRUCTIONS_ID)
        ):
            ...
            and st.getInt("cond") == 1
            and st.getQuestItemsCount(MOONFLOWER_CHARM_ID)
            and st.getQuestItemsCount(TALINS_SPEAR_ID)
            and st.getQuestItemsCount(ISAELS_LETTER_ID)
        ):
            ...
            and st.getQuestItemsCount(MOONFLOWER_CHARM_ID)
            and st.getQuestItemsCount(TALINS_SPEAR_ID)
            and st.getQuestItemsCount(GRAIL_OF_PURITY_ID)
        ):
            ...
            and st.getInt("cond") == 1
            and st.getQuestItemsCount(MOONFLOWER_CHARM_ID)
            and st.getQuestItemsCount(TEARS_OF_UNICORN_ID)
        ):
            ...
            npcId == 30371
            and st.getInt("cond") == 1
            and st.getQuestItemsCount(CAMOMILE_CHARM_ID)
            or st.getQuestItemsCount(WATER_OF_LIFE_ID)
            and st.getQuestItemsCount(MOONFLOWER_CHARM_ID) == 1
        ):
            ...
            if (
                st.getQuestItemsCount(PURE_MITHRIL_ORE_ID) >= 10
                and st.getQuestItemsCount(ANT_SOLDIER_ACID_ID) >= 20
                and st.getQuestItemsCount(WYRMS_TALON1_ID) >= 20
            ):
            ...
            npcId == 30300
            and st.getInt("cond") == 1
            and st.getQuestItemsCount(GRAIL_DIAGRAM_ID) == 0
            and st.getQuestItemsCount(PUSHKINS_LIST_ID) == 0
            and st.getQuestItemsCount(PURE_MITHRIL_CUP_ID) == 0
            and st.getQuestItemsCount(MOONFLOWER_CHARM_ID) == 1
        ):
            ...
            and st.getInt("cond") == 1
            and (
                st.getQuestItemsCount(ARKENIAS_INSTRUCTIONS_ID)
                or st.getQuestItemsCount(ADONIUS_LIST_ID)
            )
            and st.getQuestItemsCount(MOONFLOWER_CHARM_ID) == 1
        ):
            ...
            and st.getInt("cond") == 1
            and st.getQuestItemsCount(MOONFLOWER_CHARM_ID)
            and st.getQuestItemsCount(ANDARIEL_SCRIPTURE_COPY_ID)
        ):
            ...
            npcId == 30419
            and st.getInt("cond") == 1
            and st.getQuestItemsCount(THALIAS_LETTER1_ID) == 0
            and st.getQuestItemsCount(ARKENIAS_CONTRACT_ID) == 0
            and st.getQuestItemsCount(ANDARIEL_SCRIPTURE_COPY_ID) == 0
            and st.getQuestItemsCount(STARDUST_ID) == 0
            and st.getQuestItemsCount(MOONFLOWER_CHARM_ID) == 1
        ):
            ...
            and st.getInt("cond") == 1
            and st.getQuestItemsCount(MOONFLOWER_CHARM_ID)
            and st.getQuestItemsCount(ARKENIAS_INSTRUCTIONS_ID)
        ):
            ...
            and st.getInt("cond") == 1
            and st.getQuestItemsCount(MOONFLOWER_CHARM_ID)
            and st.getQuestItemsCount(ADONIUS_LIST_ID)
        ):
            if (
                st.getQuestItemsCount(SPIDER_ICHOR_ID) >= 20
                and st.getQuestItemsCount(HARPYS_DOWN_ID) >= 20
            ):
            ...
            npcId == 30375
            and st.getInt("cond") == 1
            and st.getQuestItemsCount(ARKENIAS_INSTRUCTIONS_ID) == 0
            and st.getQuestItemsCount(ADONIUS_LIST_ID) == 0
            and st.getQuestItemsCount(ANDARIEL_SCRIPTURE_COPY_ID) == 0
            and st.getQuestItemsCount(MOONFLOWER_CHARM_ID) == 1
        ):
            ...
            if (
                st.getQuestItemsCount(TALINS_SPEAR_BLADE_ID)
                and st.getQuestItemsCount(TALINS_SPEAR_SHAFT_ID)
                and st.getQuestItemsCount(TALINS_RUBY_ID)
                and st.getQuestItemsCount(TALINS_AQUAMARINE_ID)
                and st.getQuestItemsCount(TALINS_AMETHYST_ID)
                and st.getQuestItemsCount(TALINS_PERIDOT_ID)
            ):
            ...
            and st.getQuestItemsCount(GRAIL_OF_PURITY_ID)
            or st.getQuestItemsCount(WATER_OF_LIFE_ID)
            or st.getQuestItemsCount(CAMOMILE_CHARM_ID)
            and st.getQuestItemsCount(MOONFLOWER_CHARM_ID) == 1
        ):
    ...
    def onKill(self, npc, player, isPet):
        ...
        if npcId == 20550:
            ...
            if (
                st.getInt("cond")
                and st.getQuestItemsCount(MOONFLOWER_CHARM_ID) == 1
                and st.getQuestItemsCount(PUSHKINS_LIST_ID) == 1
                and st.getQuestItemsCount(PURE_MITHRIL_ORE_ID) < 10
            ):
            ...
            if (
                st.getInt("cond")
                and st.getQuestItemsCount(MOONFLOWER_CHARM_ID) == 1
                and st.getQuestItemsCount(ADONIUS_LIST_ID) == 1
                and st.getQuestItemsCount(SPIDER_ICHOR_ID) < 20
            ):
                if st.getRandom(100) < 50:
            ...
            if (
                st.getInt("cond")
                and st.getQuestItemsCount(MOONFLOWER_CHARM_ID) == 1
                and st.getQuestItemsCount(TALINS_SPEAR_ID) == 1
                and st.getQuestItemsCount(GRAIL_OF_PURITY_ID) == 1
                and st.getQuestItemsCount(TEARS_OF_UNICORN_ID) == 0
            ):
            ...
            if (
                st.getInt("cond")
                and st.getQuestItemsCount(ISAELS_INSTRUCTIONS_ID) == 1
                and st.getRandom(100) < 50
            ):
