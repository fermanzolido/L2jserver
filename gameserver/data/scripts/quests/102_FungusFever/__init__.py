    ...
    def onTalk(self, npc, player):
        ...
        if npcId == 30284 and st.getInt("cond") == 0 and st.getInt("onlyone") == 0:
            ...
            if (
                ...
                and st.getQuestItemsCount(ALBERRYUS_LETTER_ID) == 1
            ):
                htmltext = "30284-03.htm"
            elif (
                npcId == 30284
                and st.getInt("cond") == 1
                and st.getQuestItemsCount(EVERGREEN_AMULET_ID) == 1
            ):
                ...
                npcId == 30156
                and st.getInt("cond") == 2
                and st.getQuestItemsCount(EVERGREEN_AMULET_ID) > 0
                and st.getQuestItemsCount(DRYAD_TEARS_ID) < 10
            ):
                htmltext = "30156-04.htm"
            elif (
                npcId == 30156
                and st.getInt("cond") == 5
                and st.getQuestItemsCount(ALBERRYUS_LIST_ID) > 0
            ):
                htmltext = "30156-07.htm"
            elif (
                npcId == 30156
                and st.getInt("cond") == 3
                and st.getQuestItemsCount(EVERGREEN_AMULET_ID) > 0
                and st.getQuestItemsCount(DRYAD_TEARS_ID) >= 10
            ):
                ...
                npcId == 30156
                and st.getInt("cond") == 4
                and st.getQuestItemsCount(ALBERRYUS_LIST_ID) == 0
                and (
                    st.getQuestItemsCount(COBS_MEDICINE1_ID) == 1
                    or st.getQuestItemsCount(COBS_MEDICINE2_ID) == 1
                    or st.getQuestItemsCount(COBS_MEDICINE3_ID) == 1
                    or st.getQuestItemsCount(COBS_MEDICINE4_ID) == 1
                    or st.getQuestItemsCount(COBS_MEDICINE5_ID) == 1
                )
            ):
                ...
                and st.getInt("cond") == 4
                and st.getQuestItemsCount(ALBERRYUS_LIST_ID) == 0
                and st.getQuestItemsCount(COBS_MEDICINE1_ID) == 1
            ):
                ...
                npcId == 30284
                and st.getInt("cond") == 5
                and st.getQuestItemsCount(ALBERRYUS_LIST_ID) == 1
                and (
                    st.getQuestItemsCount(COBS_MEDICINE1_ID) == 1
                    or st.getQuestItemsCount(COBS_MEDICINE2_ID) == 1
                    or st.getQuestItemsCount(COBS_MEDICINE3_ID) == 1
                ...
                and st.getInt("cond") == 5
                and st.getQuestItemsCount(ALBERRYUS_LIST_ID) == 1
                and st.getQuestItemsCount(COBS_MEDICINE2_ID) == 1
            ):
                ...
                and st.getInt("cond") == 5
                and st.getQuestItemsCount(ALBERRYUS_LIST_ID) == 1
                and st.getQuestItemsCount(COBS_MEDICINE3_ID) == 1
            ):
                ...
                and st.getInt("cond") == 5
                and st.getQuestItemsCount(ALBERRYUS_LIST_ID) == 1
                and st.getQuestItemsCount(COBS_MEDICINE4_ID) == 1
            ):
                ...
                and st.getInt("cond") == 5
                and st.getQuestItemsCount(ALBERRYUS_LIST_ID) == 1
                and st.getQuestItemsCount(COBS_MEDICINE5_ID) == 1
            ):
    ...
    def onKill(self, npc, player, isPet):
        ...
        if st.getState() == STARTED:
            ...
            if npcId in [20013, 20019]:
                if (
                    st.getQuestItemsCount(EVERGREEN_AMULET_ID) > 0
                    and st.getQuestItemsCount(DRYAD_TEARS_ID) < 10
                ):
