        ...
        if st:
            ...
            if npcId == 31521 and cond == 0:
                ...
                if npcId == 31543 and cond == 1 and st.getQuestItemsCount(BOILED_EGGS):
                    ...
                    npcId == 31544 and cond == 2 and st.getQuestItemsCount(BOILED_EGGS)
                ):
                    htmltext = "31544-0.htm"
                elif (
                    npcId == 31545 and cond == 3 and st.getQuestItemsCount(BOILED_EGGS)
                ):
                    htmltext = "31545-0.htm"
                elif (
                    npcId == 31546 and cond == 4 and st.getQuestItemsCount(BOILED_EGGS)
                ):
                    htmltext = "31546-0.htm"
                elif (
                    npcId == 31547 and cond == 5 and st.getQuestItemsCount(BOILED_EGGS)
                ):
                    htmltext = "31547-0.htm"
                elif (
                    npcId == 31521
                    and cond == 6
                    and st.getQuestItemsCount(FEE_OF_EGGS) == 5
                ):
