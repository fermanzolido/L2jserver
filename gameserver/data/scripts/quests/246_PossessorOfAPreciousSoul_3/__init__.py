    ...
    def onTalk(self, npc, player):
        ...
        if player.isSubClassActive():
            if (
                npcId == CARADINE
                and cond == 0
                and st.getQuestItemsCount(CARADINE_LETTER) == 1
            ):
                if id == COMPLETED:
            ...
            if (
                npcId == OSSIAN
                and cond == 3
                and st.getQuestItemsCount(WATERBINDER) == 1
                and st.getQuestItemsCount(EVERGREEN) == 1
            ):
            ...
            if party:
                for partyMember in party.getPartyMembers().toArray():
                    ...
                    if pst:
                        if (
                            pst.getInt("cond") == 4
                            and pst.getQuestItemsCount(RAIN_SONG) < 1
                        ):
