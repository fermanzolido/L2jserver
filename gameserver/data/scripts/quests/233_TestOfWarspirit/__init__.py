...
DROPLIST = {
    ...
    20089: [
        ...
        100,
        [
            [KIRUNAS_THIGH_BONE, KIRUNAS_ARM_BONE],
            [KIRUNAS_SPINE, KIRUNAS_RIB_BONE],
            [KIRUNAS_SKULL],
        ],
    ],
    20090: [
...
class Quest(JQuest):
    ...
    def onTalk(self, npc, player):
        ...
        # if quest is accepted and in progress
            ...
            if npcId == NPC[3]:
                if (
                    Orim == 6 and Racoy == 11 and Perkiron == 8 and Manakia == 7
                ):  # Step 1 finished
            ...
            # Manakias Part, hunt Medusas Steona Gorgogon Queen
                ...
                if Manakia == 1:  # explanation
                    ...
                    Manakia == 6 and st.getInt("Manakia_Queen") == 3
                ):  # ah you got both items i need
            ...
            if npcId == NPC[3]:
                if step == 1:  # explain Part 2 again or bring more skulls
                    ...
                    st.takeItems(
                        TAMLIN_ORC_HEAD, st.getQuestItemsCount(TAMLIN_ORC_HEAD)
                    )
                ...
                htmltext = (
                    "30649-01.htm"  # ah thx.. i will give you the mark of War Spirit
                )
        return htmltext
    ...
    def onKill(self, npc, player, isPet):
        ...
        if (st.getState() == PART1) and not (npcId in PART1_MOBS):
            return
        if (st.getState() == PART2) and not (npcId in PART2_MOBS):
            return
