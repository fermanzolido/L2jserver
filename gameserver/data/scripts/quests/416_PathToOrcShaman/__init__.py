...
class Quest(JQuest):
    ...
    def onTalk(self, npc, player):
        ...
        if npcId == 30585 and st.getInt("cond") == 0:
            ...
            npcId == 30585
            and st.getInt("cond")
            and st.getQuestItemsCount(HESTUI_MASK) == 1
            and st.getQuestItemsCount(FIERY_EGG2) == 1
        ):
            htmltext = "30585-09.htm"
        elif (
            npcId == 30585
            and st.getInt("cond")
            and st.getQuestItemsCount(TOTEM_SPIRIT_CLAW) == 1
        ):
            htmltext = "30585-10.htm"
        elif (
            npcId == 30585
            and st.getInt("cond")
            and st.getQuestItemsCount(TATARUS_LETTER) == 1
        ):
            ...
            npcId == 30592
            and st.getInt("cond")
            and st.getQuestItemsCount(HESTUI_MASK)
            and st.getQuestItemsCount(FIERY_EGG2)
        ):
            htmltext = "30592-01.htm"
        elif (
            npcId == 30592
            and st.getInt("cond")
            and st.getQuestItemsCount(TOTEM_SPIRIT_CLAW)
        ):
            ...
            npcId == 30502
            and st.getInt("cond")
            and st.getQuestItemsCount(TATARUS_LETTER)
        ):
            ...
            npcId == 30502
            and st.getInt("cond")
            and st.getQuestItemsCount(FLAME_CHARM) == 1
            and st.getQuestItemsCount(GRIZZLY_BLOOD) < 3
        ):
            ...
            npcId == 30502
            and st.getInt("cond")
            and st.getQuestItemsCount(BLOOD_CAULDRON) == 1
        ):
            ...
            npcId == 30502
            and st.getInt("cond")
            and st.getQuestItemsCount(TOTEM_SPIRIT_BLOOD) == 1
        ):
            htmltext = "30502-06.htm"
        elif (
            npcId == 30593
            and st.getInt("cond")
            and st.getQuestItemsCount(BLOOD_CAULDRON)
        ):
            htmltext = "30593-01.htm"
        elif (
            npcId == 30593
            and st.getInt("cond")
            and st.getQuestItemsCount(SPIRIT_NET)
            and st.getQuestItemsCount(BOUND_DURKA_SPIRIT) == 0
        ):
            htmltext = "30593-04.htm"
        elif (
            npcId == 30593
            and st.getInt("cond")
            and st.getQuestItemsCount(SPIRIT_NET) == 0
            and st.getQuestItemsCount(BOUND_DURKA_SPIRIT)
        ):
            ...
            and st.getQuestItemsCount(TOTEM_SPIRIT_BLOOD)
        ):
    ...
    def onKill(self, npc, player, isPet):
        ...
        if npcId == 20479:
            ...
            if (
                st.getInt("cond")
                and st.getQuestItemsCount(FIRE_CHARM) == 1
                and st.getQuestItemsCount(KASHA_BEAR_PELT) < 1
            ):
                if (
                    st.getQuestItemsCount(KASHA_BEAR_PELT)
                    + st.getQuestItemsCount(KASHA_BSPIDER_HUSK)
            ...
            if (
                st.getInt("cond")
                and st.getQuestItemsCount(FIRE_CHARM) == 1
                and st.getQuestItemsCount(KASHA_BSPIDER_HUSK) < 1
            ):
                if (
                    st.getQuestItemsCount(KASHA_BEAR_PELT)
                    + st.getQuestItemsCount(KASHA_BSPIDER_HUSK)
            ...
            if (
                st.getInt("cond")
                and st.getQuestItemsCount(FIRE_CHARM) == 1
                and st.getQuestItemsCount(FIERY_EGG1) < 1
            ):
                if (
                    st.getQuestItemsCount(KASHA_BEAR_PELT)
                    + st.getQuestItemsCount(KASHA_BSPIDER_HUSK)
            ...
            if (
                st.getInt("cond")
                and st.getQuestItemsCount(SPIRIT_NET) == 1
                and st.getQuestItemsCount(BOUND_DURKA_SPIRIT) == 0
                and st.getQuestItemsCount(DURKA_PARASITE) < 8
            ):
                n = st.getRandom(10)
