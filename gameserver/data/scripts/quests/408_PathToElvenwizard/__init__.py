...
class Quest(JQuest):
    ...
    def onEvent(self, event, st):
        ...
        if event == "1":
            ...
            if (
                st.getInt("cond") != 0
                and st.getQuestItemsCount(MAGICAL_POWERS_RUBY) != 0
            ):
            ...
            if st.getInt("cond") != 0 and st.getQuestItemsCount(PURE_AQUAMARINE) != 0:
                ...
                st.getInt("cond") != 0
                and st.getQuestItemsCount(PURE_AQUAMARINE) == 0
                and st.getQuestItemsCount(FERTILITY_PERIDOT) != 0
            ):
            ...
            if st.getInt("cond") != 0 and st.getQuestItemsCount(NOBILITY_AMETHYST) != 0:
                ...
                st.getInt("cond") != 0
                and st.getQuestItemsCount(NOBILITY_AMETHYST) == 0
                and st.getQuestItemsCount(FERTILITY_PERIDOT) != 0
            ):
    ...
    def onTalk(self, npc, player):
        ...
        if npcId == 30414 and st.getInt("cond") == 0:
            ...
            and st.getQuestItemsCount(ROGELLIAS_LETTER) == 0
            and st.getQuestItemsCount(APPETIZING_APPLE) == 0
            and st.getQuestItemsCount(IMMORTAL_LOVE) == 0
            and st.getQuestItemsCount(CHARM_OF_GRAIN) == 0
            and st.getQuestItemsCount(SAP_OF_WORLD_TREE) == 0
            and st.getQuestItemsCount(LUCKY_POTPOURI) == 0
            and st.getQuestItemsCount(FERTILITY_PERIDOT) != 0
            and (
                st.getQuestItemsCount(MAGICAL_POWERS_RUBY) == 0
                or st.getQuestItemsCount(NOBILITY_AMETHYST) == 0
                or st.getQuestItemsCount(PURE_AQUAMARINE) == 0
            )
        ):
            ...
            and st.getInt("cond") != 0
            and st.getQuestItemsCount(CHARM_OF_GRAIN) != 0
            and st.getQuestItemsCount(RED_DOWN) < 5
        ):
            ...
            and st.getInt("cond") != 0
            and st.getQuestItemsCount(SAP_OF_WORLD_TREE) != 0
            and st.getQuestItemsCount(GOLD_LEAVES) < 5
        ):
            ...
            and st.getInt("cond") != 0
            and st.getQuestItemsCount(LUCKY_POTPOURI) != 0
            and st.getQuestItemsCount(AMETHYST) < 2
        ):
            ...
            st.takeItems(
                MAGICAL_POWERS_RUBY, st.getQuestItemsCount(MAGICAL_POWERS_RUBY)
            )
