...
class Quest(JQuest):
    ...
    def onEvent(self, event, st):
        ...
        if event == "1":
            ...
            if st.getGameTicks() != st.getInt("id"):
                ...
                st.takeItems(
                    JOURNEYMAN_RING_ID, st.getQuestItemsCount(JOURNEYMAN_RING_ID)
                )
    ...
    def onTalk(self, npc, player):
        ...
        if npcId == 30103 and st.getInt("cond") == 0 and st.getInt("onlyone") == 0:
            ...
            and st.getQuestItemsCount(VALKONS_RECOMMEND_ID) == 1
        ):
            htmltext = "30103-07.htm"
        elif (
            npcId == 30103
            and st.getInt("cond") >= 1
            and st.getQuestItemsCount(ALLTRANS_INSTRUCTIONS_ID) == 1
        ):
            ...
            and st.getInt("cond") >= 1
            and st.getQuestItemsCount(VALKONS_RECOMMEND_ID) == 1
            and st.getQuestItemsCount(MANDRAGORA_BERRY_ID) == 0
        ):
            ...
            and st.getInt("cond") >= 1
            and st.getQuestItemsCount(VALKONS_RECOMMEND_ID) == 1
            and st.getQuestItemsCount(MANDRAGORA_BERRY_ID) == 1
        ):
            ...
            and st.getInt("cond") >= 1
            and st.getQuestItemsCount(ALLTRANS_INSTRUCTIONS_ID) == 1
            and st.getQuestItemsCount(ALLTRANS_RECOMMEND1_ID) == 1
        ):
            htmltext = "30210-01.htm"
        elif (
            npcId == 30210
            and st.getInt("cond") >= 1
            and st.getQuestItemsCount(ALLTRANS_INSTRUCTIONS_ID)
            and st.getQuestItemsCount(NORMANS_INSTRUCTIONS_ID)
            and st.getQuestItemsCount(NORMANS_RECEIPT_ID)
        ):
            ...
            and st.getQuestItemsCount(ALLTRANS_INSTRUCTIONS_ID)
            and st.getQuestItemsCount(NORMANS_INSTRUCTIONS_ID)
            and st.getQuestItemsCount(DUNINGS_INSTRUCTIONS_ID)
        ):
            ...
            and st.getQuestItemsCount(ALLTRANS_INSTRUCTIONS_ID)
            and st.getQuestItemsCount(NORMANS_INSTRUCTIONS_ID)
            and st.getQuestItemsCount(DUNINGS_KEY_ID) >= 30
        ):
            ...
            and st.getInt("cond") >= 1
            and st.getQuestItemsCount(ALLTRANS_INSTRUCTIONS_ID)
            and st.getQuestItemsCount(NORMANS_LIST_ID)
        ):
            if (
                st.getQuestItemsCount(GRAY_BONE_POWDER_ID) >= 70
                and st.getQuestItemsCount(GRANITE_WHETSTONE_ID) >= 70
            ):
                htmltext = "30210-12.htm"
                st.takeItems(NORMANS_LIST_ID, 1)
                st.takeItems(
                    GRAY_BONE_POWDER_ID, st.getQuestItemsCount(GRAY_BONE_POWDER_ID)
                )
                st.takeItems(
                    GRANITE_WHETSTONE_ID, st.getQuestItemsCount(GRANITE_WHETSTONE_ID)
                )
            ...
            npcId == 30210
            and st.getInt("cond") >= 1
            and st.getQuestItemsCount(NORMANS_INSTRUCTIONS_ID) == 0
            and st.getQuestItemsCount(NORMANS_LIST_ID) == 0
            and st.getQuestItemsCount(ALLTRANS_INSTRUCTIONS_ID) == 1
            and (
                st.getQuestItemsCount(JOURNEYMAN_GEM_ID)
                or st.getQuestItemsCount(JOURNEYMAN_RING_ID)
            )
        ):
            ...
            npcId == 30688
            and st.getInt("cond") >= 1
            and st.getQuestItemsCount(NORMANS_RECEIPT_ID) == 0
            and st.getQuestItemsCount(DUNINGS_INSTRUCTIONS_ID) == 0
            and st.getQuestItemsCount(DUNINGS_KEY_ID) == 0
            and st.getQuestItemsCount(ALLTRANS_INSTRUCTIONS_ID) == 1
        ):
            htmltext = "30688-01.htm"
        elif (
            ...
            and st.getInt("cond") >= 1
            and st.getQuestItemsCount(ALLTRANS_INSTRUCTIONS_ID)
            and st.getQuestItemsCount(ALLTRANS_RECOMMEND2_ID)
        ):
            ...
            and st.getInt("cond") >= 1
            and st.getQuestItemsCount(ALLTRANS_INSTRUCTIONS_ID)
            and st.getQuestItemsCount(PINTERS_INSTRUCTIONS_ID)
        ):
            ...
            and st.getInt("cond") >= 1
            and st.getQuestItemsCount(ALLTRANS_INSTRUCTIONS_ID) == 1
            and st.getQuestItemsCount(PINTERS_INSTRUCTIONS_ID) == 0
            and (
                st.getQuestItemsCount(JOURNEYMAN_DECO_BEADS_ID)
                or st.getQuestItemsCount(JOURNEYMAN_RING_ID)
            )
        ):
    ...
    def onKill(self, npc, player, isPet):
        ...
        if npcId == 20223:
            ...
            if (
                st.getInt("cond") >= 1
                and st.getQuestItemsCount(ALLTRANS_INSTRUCTIONS_ID) == 1
                and st.getQuestItemsCount(NORMANS_INSTRUCTIONS_ID) == 1
                and st.getQuestItemsCount(DUNINGS_INSTRUCTIONS_ID) == 1
            ):
                if (
                    st.getRandom(100) <= 30
                    and st.getQuestItemsCount(DUNINGS_KEY_ID) <= 29
                ):
            ...
            if (
                st.getInt("cond") >= 1
                and st.getQuestItemsCount(ALLTRANS_INSTRUCTIONS_ID) == 1
                and st.getQuestItemsCount(NORMANS_LIST_ID) == 1
                and st.getQuestItemsCount(GRAY_BONE_POWDER_ID) <= 68
            ):
            ...
            if (
                ...
                and st.getQuestItemsCount(ALLTRANS_INSTRUCTIONS_ID) == 1
                and st.getQuestItemsCount(NORMANS_LIST_ID) == 1
                and st.getQuestItemsCount(GRANITE_WHETSTONE_ID) <= 68
            ):
            ...
            if (
                ...
                and st.getQuestItemsCount(ALLTRANS_INSTRUCTIONS_ID) == 1
                and st.getQuestItemsCount(NORMANS_LIST_ID) == 1
                and st.getQuestItemsCount(RED_PIGMENT_ID) <= 68
            ):
            ...
            if (
                ...
                and st.getQuestItemsCount(ALLTRANS_INSTRUCTIONS_ID) == 1
                and st.getQuestItemsCount(NORMANS_LIST_ID) == 1
                and st.getQuestItemsCount(BRAIDED_YARN_ID) <= 68
            ):
            ...
            if (
                st.getInt("cond") >= 1
                and st.getQuestItemsCount(ALLTRANS_INSTRUCTIONS_ID) == 1
                and st.getQuestItemsCount(PINTERS_INSTRUCTIONS_ID) == 1
            ):
                if st.getQuestItemsCount(AMBER_BEAD_ID) < 70:
                    if (
                        st.getRandom(100) < 50 and player.getClassId().getId() == 0x36
                    ):  # and IsSpoiled() == 1 :
