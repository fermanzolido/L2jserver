    ...
    def onTalk(self, npc, player):
        ...
        if player.isSubClassActive():
            if (
                npcId == VIRGIL
                and cond == 0
                and st.getQuestItemsCount(VIRGILS_LETTER) == 1
            ):
                if id == COMPLETED:
            ...
            if npcId == ANGEL_CORPSE and cond == 5:
                htmltext = "31752-2.htm"
            if (
                npcId == MYSTERIOUS_KNIGHT
                and cond == 5
                and st.getQuestItemsCount(GOLDEN_HAIR) == 1
            ):
            ...
            if (
                npcId == KALIS
                and cond == 8
                and st.getQuestItemsCount(SORCERY_INGREDIENT) == 1
            ):
            ...
            if (
                npcId == CORNERSTONE
                and cond == 9
                and st.getQuestItemsCount(ORB_oF_BINDING) == 0
            ):
                htmltext = "31748-1.htm"
            if (
                npcId == CORNERSTONE
                and cond == 9
                and st.getQuestItemsCount(ORB_oF_BINDING) >= 1
            ):
