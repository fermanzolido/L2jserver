...
class Quest(JQuest):
    ...
    def onAdvEvent(self, event, npc, player):
        ...
        if event == "31334-02.htm":
            ...
            if st2:
                if not (
                    st2.getState().getName() == "Completed" and player.getLevel() >= 63
                ):
            ...
            if (
                st.getInt("id") == 2
                and st.getQuestItemsCount(CROSS) > 0
                and st.getQuestItemsCount(SKULL) > 0
            ):
                if self.tifaren == 1:
            ...
            if self.well == 0:
                ...
                soul.getAI().setIntention(
                    CtrlIntention.AI_INTENTION_ATTACK, player, None
                )
            else:
            ...
            AutoChat(
                npc,
                "My train of thought is chaotic. It goes back to the beginning of time...",
            )
