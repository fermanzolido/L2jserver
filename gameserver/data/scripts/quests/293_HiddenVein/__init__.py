            ...
            if st.getInt("cond") == 0:
                ...
                if st.getQuestItemsCount(CHRYSOLITE_ORE) == 0:
                    if st.getQuestItemsCount(HIDDEN_VEIN_MAP) == 0:
                        ...
                        st.giveItems(
                            ADENA, st.getQuestItemsCount(HIDDEN_VEIN_MAP) * 1000
                        )
                    ...
                    if st.getQuestItemsCount(HIDDEN_VEIN_MAP) == 0:
                        ...
                        st.giveItems(
                            ADENA,
                            st.getQuestItemsCount(CHRYSOLITE_ORE) * 10
                            + st.getQuestItemsCount(HIDDEN_VEIN_MAP) * 1000,
                        )
                        st.takeItems(HIDDEN_VEIN_MAP, -1)
                        st.takeItems(CHRYSOLITE_ORE, -1)
        elif npcId == 30539:
