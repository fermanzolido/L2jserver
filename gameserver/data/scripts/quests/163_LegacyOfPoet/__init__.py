...
class Quest(JQuest):
    ...
    def onTalk(self, npc, player):
        ...
        if npcId == 30220 and st.getInt("cond") == 0 and st.getInt("onlyone") == 0:
            ...
            if (
                st.getQuestItemsCount(RUMIELS_POEM_1_ID) == 1
                and st.getQuestItemsCount(RUMIELS_POEM_3_ID) == 1
                and st.getQuestItemsCount(RUMIELS_POEM_4_ID) == 1
                and st.getQuestItemsCount(RUMIELS_POEM_5_ID) == 1
    ...
    def onKill(self, npc, player, isPet):
        ...
        if npcId == 20372:
            ...
            if st.getInt("cond") == 1:
                if (
                    st.getRandom(10) == 0
                    and st.getQuestItemsCount(RUMIELS_POEM_1_ID) == 0
                ):
                    st.giveItems(RUMIELS_POEM_1_ID, 1)
                    if (
                        st.getQuestItemsCount(RUMIELS_POEM_1_ID)
                        + st.getQuestItemsCount(RUMIELS_POEM_3_ID)
                        + st.getQuestItemsCount(RUMIELS_POEM_4_ID)
                        + st.getQuestItemsCount(RUMIELS_POEM_5_ID)
                        == 4
                    ):
                ...
                if (
                    st.getRandom(10) > 7
                    and st.getQuestItemsCount(RUMIELS_POEM_3_ID) == 0
                ):
                ...
                if (
                    st.getRandom(10) > 7
                    and st.getQuestItemsCount(RUMIELS_POEM_4_ID) == 0
                ):
                ...
                if (
                    st.getRandom(10) > 5
                    and st.getQuestItemsCount(RUMIELS_POEM_5_ID) == 0
                ):
