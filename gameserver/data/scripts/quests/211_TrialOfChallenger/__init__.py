...
class Quest(JQuest):
    ...
    def onTalk(self, npc, player):
        ...
        if id == CREATED:
            ...
            npcId == 30644
            and cond == 2
            and st.getQuestItemsCount(SCROLL_OF_SHYSLASSY) == 1
        ):
            ...
            npcId == 30644 and cond == 1 and st.getQuestItemsCount(LETTER_OF_KASH) == 1
        ):
            htmltext = "30644-08.htm"
        elif npcId == 30644 and cond >= 7:
            htmltext = "30644-09.htm"
        elif (
            npcId == 30645 and cond == 3 and st.getQuestItemsCount(LETTER_OF_KASH) == 1
        ):
