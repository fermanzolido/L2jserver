...
NUCLEUS_OF_LESSER_GOLEM = (
    8491  # Nucleus of Lesser Golem: Nucleus obtained by defeating the Lesser Golem.
)
FALSTON_FANG = (
    8492  # Falston's Fang: Fangs obtained by killing Falston, the Demon's Agent.
)
SHAIDS_TALON = (
    8493  # Shaid's Talon: Talon obtained by defeating Spike Stakato Queen Shaid.
)
