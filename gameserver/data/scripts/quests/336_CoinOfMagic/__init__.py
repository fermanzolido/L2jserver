...
(
    ...
    NIHIL_INV,
    DARK_GUARD,
) = (21003, 21008, 20674, 21006, 21521, 21531, 21526, 21539, 20954, 20960, 20957, 20959)
...
DROP_LIST = {
    TIMAKSHAM: [BLOOD_MEDUSA],
    TIMAKARCH: [BLOOD_MEDUSA],
    TIMAKSOLD: [BLOOD_MEDUSA],
    LAKIN: [BLOOD_MEDUSA],
    PUNISHMENT: [BLOOD_MEDUSA],
    KOOKABU1: [BLOOD_MEDUSA],
    KOOKABU2: [BLOOD_MEDUSA],
    KOOKABU3: [BLOOD_MEDUSA],
    KOOKABU4: [BLOOD_MEDUSA],
    BANDERSN1: [BLOOD_MEDUSA],
    BANDERSN2: [BLOOD_MEDUSA],
    BANDERSN3: [BLOOD_MEDUSA],
    BANDERSN4: [BLOOD_MEDUSA],
    PUNISH_SPL: [BLOOD_MEDUSA],
    HUNGRY_C: [BLOOD_MEDUSA],
    BLOODY_G: [BLOOD_MEDUSA],
    DOOM_SERV: [BLOOD_MEDUSA],
    GRAVE_L: [BLOOD_MEDUSA],
    TIMAKORC: [GOLD_WYVERN],
    HATARHANI: [GOLD_WYVERN],
    SHACKLE: [GOLD_WYVERN],
    HEADLESS: [GOLD_WYVERN],
    ROYALSERVANT: [GOLD_WYVERN],
    MALRUKTUREN: [GOLD_WYVERN],
    SHACKL2: [GOLD_WYVERN],
    HEADLES2: [GOLD_WYVERN],
    ROYALSERVAN2: [GOLD_WYVERN],
    MALRUKTURE2: [GOLD_WYVERN],
    ANTELOP1: [GOLD_WYVERN],
    ANTELOP2: [GOLD_WYVERN],
    ANTELOP3: [GOLD_WYVERN],
    ANTELOP4: [GOLD_WYVERN],
    WAILING_SPL: [GOLD_WYVERN],
    CLAW_SPL: [GOLD_WYVERN],
    NIHIL_INV: [GOLD_WYVERN],
    DOOM_ARC: [GOLD_WYVERN],
    FORMOR: [SILVER_UNICORN],
    FORMORELDER: [SILVER_UNICORN],
    VANORSHAMAN: [SILVER_UNICORN],
    TARLKHIWARRIOR: [SILVER_UNICORN],
    OLMAHUM: [SILVER_UNICORN],
    OLMAHUMW: [SILVER_UNICORN],
    BUFALO1: [SILVER_UNICORN],
    BUFALO2: [SILVER_UNICORN],
    BUFALO3: [SILVER_UNICORN],
    BUFALO4: [SILVER_UNICORN],
    WISDOM_SPL: [SILVER_UNICORN],
    DARK_GUARD: [SILVER_UNICORN],
    DOOM_KNI: [SILVER_UNICORN],
    HARITMATR: [KALDIS_COIN],
    HARITSHA: [KALDIS_COIN],
}

EXCHANGE_LIST = {
    PAGE: {
        GOLD_KNIGHT: {GOLD_WYVERN: 10},
        SILVER_FAIRY: {SILVER_UNICORN: 10},
        BLOOD_WEREWOLF: {BLOOD_MEDUSA: 10},
        NIAS_BLOOD_MEDUSA: {BLOOD_MEDUSA: 20},
    },
    LORAIN: {
        GOLD_KNIGHT: {GOLD_WYVERN: 10},
        SILVER_GOLEM: {SILVER_UNICORN: 10},
        BLOOD_DREVANUL: {BLOOD_MEDUSA: 10},
        NIAS_GOLD_WYVERN: {GOLD_WYVERN: 20},
    },
    HAGGER: {
        GOLD_DRAKE: {GOLD_WYVERN: 10},
        SILVER_GOLEM: {SILVER_UNICORN: 10},
        BLOOD_WEREWOLF: {BLOOD_MEDUSA: 10},
        NIAS_SILVER_FAIRY: {SILVER_UNICORN: 20},
    },
    RALFORD: {
        GOLD_WYRM: {GOLD_DRAKE: 5, GOLD_KNIGHT: 5},
        SILVER_DRYAD: {SILVER_GOLEM: 5, SILVER_FAIRY: 5},
        SILVER_UNDINE: {SILVER_GOLEM: 5, SILVER_FAIRY: 5},
        MANAKS_BLOOD_WEREWOLF: {BLOOD_DREVANUL: 10, BLOOD_WEREWOLF: 10},
    },
    STAN: {
        GOLD_GIANT: {GOLD_DRAKE: 5, GOLD_KNIGHT: 5},
        BLOOD_BASILISK: {BLOOD_DREVANUL: 5, BLOOD_WEREWOLF: 5},
        SILVER_UNDINE: {SILVER_GOLEM: 5, SILVER_FAIRY: 5},
        MANAKS_SILVER_DRYAD: {SILVER_GOLEM: 10, SILVER_FAIRY: 10},
    },
    DUNING: {
        GOLD_GIANT: {GOLD_DRAKE: 5, GOLD_KNIGHT: 5},
        BLOOD_SUCCUBUS: {BLOOD_DREVANUL: 5, BLOOD_WEREWOLF: 5},
        SILVER_UNDINE: {SILVER_GOLEM: 5, SILVER_FAIRY: 5},
        MANAKS_GOLD_GIANT: {GOLD_DRAKE: 10, GOLD_KNIGHT: 10},
    },
    FERRIS: {
        BLOOD_DRAGON: {BLOOD_SUCCUBUS: 5, BLOOD_BASILISK: 5},
        SILVER_DRAGON: {SILVER_DRYAD: 5, SILVER_UNDINE: 5},
        GOLD_DRAGON: {GOLD_WYRM: 5, GOLD_GIANT: 5},
        BELETHS_BLOOD: {BLOOD_SUCCUBUS: 10, BLOOD_BASILISK: 10},
    },
    COLLOB: {
        BLOOD_DRAGON: {BLOOD_SUCCUBUS: 5, BLOOD_BASILISK: 5},
        SILVER_DRAGON: {SILVER_DRYAD: 5, SILVER_UNDINE: 5},
        GOLD_DRAGON: {GOLD_WYRM: 5, GOLD_GIANT: 5},
        BELETHS_GOLD: {GOLD_WYRM: 10, GOLD_GIANT: 10},
    },
    PANO: {
        BLOOD_DRAGON: {BLOOD_SUCCUBUS: 5, BLOOD_BASILISK: 5},
        SILVER_DRAGON: {SILVER_DRYAD: 5, SILVER_UNDINE: 5},
        GOLD_DRAGON: {GOLD_WYRM: 5, GOLD_GIANT: 5},
        BELETHS_SILVER: {SILVER_DRYAD: 10, SILVER_UNDINE: 10},
    },
}

GAMBLE_LIST = {
    PAGE: {
        GOLD_KNIGHT: [GOLD_WYVERN],
        SILVER_FAIRY: [SILVER_UNICORN],
        BLOOD_WEREWOLF: [BLOOD_MEDUSA],
        NIAS_BLOOD_MEDUSA: [BLOOD_MEDUSA],
    },
    LORAIN: {
        GOLD_KNIGHT: [GOLD_WYVERN],
        SILVER_GOLEM: [SILVER_UNICORN],
        BLOOD_DREVANUL: [BLOOD_MEDUSA],
        NIAS_GOLD_WYVERN: [GOLD_WYVERN],
    },
    HAGGER: {
        GOLD_DRAKE: [GOLD_WYVERN],
        SILVER_GOLEM: [SILVER_UNICORN],
        BLOOD_WEREWOLF: [BLOOD_MEDUSA],
        NIAS_SILVER_FAIRY: [SILVER_UNICORN],
    },
    RALFORD: {
        GOLD_WYRM: [GOLD_DRAKE],
        SILVER_DRYAD: [SILVER_FAIRY],
        SILVER_UNDINE: [SILVER_GOLEM],
        MANAKS_BLOOD_WEREWOLF: [BLOOD_DREVANUL, BLOOD_WEREWOLF],
    },
    STAN: {
        GOLD_GIANT: [GOLD_DRAKE],
        BLOOD_BASILISK: [BLOOD_WEREWOLF],
        SILVER_UNDINE: [SILVER_FAIRY],
        MANAKS_SILVER_DRYAD: [SILVER_GOLEM, SILVER_FAIRY],
    },
    DUNING: {
        GOLD_GIANT: [GOLD_DRAKE],
        BLOOD_SUCCUBUS: [BLOOD_DREVANUL],
        SILVER_UNDINE: [SILVER_FAIRY],
        MANAKS_GOLD_GIANT: [GOLD_DRAKE, GOLD_KNIGHT],
    },
    FERRIS: {
        BLOOD_DRAGON: [BLOOD_BASILISK],
        SILVER_DRAGON: [SILVER_DRYAD],
        GOLD_DRAGON: [GOLD_GIANT],
        BELETHS_BLOOD: [BLOOD_SUCCUBUS, BLOOD_BASILISK],
    },
    COLLOB: {
        BLOOD_DRAGON: [BLOOD_SUCCUBUS],
        SILVER_DRAGON: [SILVER_UNDINE],
        GOLD_DRAGON: [GOLD_WYRM],
...
class Quest(JQuest):
        ...
        if event == "30702-06.htm":
            ...
            if item in list(TRADE_LIST.keys()):
                ...
                for i in range(len(TRADE_LIST[item])):
                    if (
                        st.getQuestItemsCount(TRADE_LIST[item][i][0])
                        >= TRADE_LIST[item][i][1]
                    ):
                        j += 1
                if j == k:
                        ...
                        if count == 3:
                            ...
                            if tries:
                                ...
                                for var in [
                                    ...
                                    st.unset(var)
                                return (
                                    st.showHtmlFile(npc + "-" + next + ".htm")
                                    .replace("%first%", msg[0])
                                    .replace("%second%", msg[1])
                                    .replace("%third%", msg[2])
                                )
                    else:
    ...
    def onTalk(self, npc, player):
        ...
        npcId = npc.getNpcId()
        id = st.getState()
        if npcId != SORINT and id == CREATED:
            return htmltext
        if npcId != SORINT and npcId != BERNARD and id == SOLO:
            return htmltext
