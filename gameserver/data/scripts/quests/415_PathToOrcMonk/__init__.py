...
class Quest(JQuest):
    ...
    def onTalk(self, npc, player):
        ...
        if npcId == 30587 and st.getInt("cond") == 0 and st.getInt("onlyone") == 0:
            ...
            npcId == 30587
            and st.getInt("cond")
            and st.getQuestItemsCount(SCROLL_FIERY_SPIRIT) == 0
            and st.getQuestItemsCount(POMEGRANATE) == 1
            and st.getQuestItemsCount(GANTAKIS_LETTER) == 0
            and st.getQuestItemsCount(ROSHEEKS_LETTER) == 0
            and (
                (
            ...
            and st.getInt("cond")
            and st.getQuestItemsCount(SCROLL_FIERY_SPIRIT) == 0
            and st.getQuestItemsCount(POMEGRANATE) == 0
            and st.getQuestItemsCount(GANTAKIS_LETTER) == 0
            and st.getQuestItemsCount(ROSHEEKS_LETTER) == 0
            and (
                (
            ...
            npcId == 30587
            and st.getInt("cond")
            and st.getQuestItemsCount(SCROLL_FIERY_SPIRIT) == 1
            and st.getQuestItemsCount(POMEGRANATE) == 0
            and st.getQuestItemsCount(GANTAKIS_LETTER) == 0
            and st.getQuestItemsCount(ROSHEEKS_LETTER) == 1
            and (
                (
                    st.getQuestItemsCount(LEATHER_POUCH1)
                    + st.getQuestItemsCount(LEATHER_POUCH2)
            ...
            and st.getQuestItemsCount(SCROLL_FIERY_SPIRIT) == 1
            and st.getQuestItemsCount(POMEGRANATE) == 0
            and st.getQuestItemsCount(GANTAKIS_LETTER) == 1
            and st.getQuestItemsCount(ROSHEEKS_LETTER) == 0
            and (
                (
                    st.getQuestItemsCount(LEATHER_POUCH1)
            ...
            npcId == 30590 and st.getInt("cond") and st.getQuestItemsCount(POMEGRANATE)
        ):
            ...
            npcId == 30590
            and st.getInt("cond")
            and st.getQuestItemsCount(LEATHER_POUCH1)
            and st.getQuestItemsCount(LEATHER_POUCH1FULL) == 0
        ):
            htmltext = "30590-02.htm"
        elif (
            npcId == 30590
            and st.getInt("cond")
            and st.getQuestItemsCount(LEATHER_POUCH1) == 0
            ...
            npcId == 30590
            and st.getInt("cond")
            and st.getQuestItemsCount(LEATHER_POUCH2) == 1
            and st.getQuestItemsCount(LEATHER_POUCH2FULL) == 0
        ):
            htmltext = "30590-04.htm"
        elif (
            npcId == 30590
            and st.getInt("cond")
            and st.getQuestItemsCount(LEATHER_POUCH2) == 0
            and st.getQuestItemsCount(LEATHER_POUCH2FULL) == 1
        ):
            ...
            npcId == 30590
            and st.getInt("cond")
            and st.getQuestItemsCount(LEATHER_POUCH3) == 1
            and st.getQuestItemsCount(LEATHER_POUCH3FULL) == 0
        ):
            htmltext = "30590-06.htm"
        elif (
            npcId == 30590
            and st.getInt("cond")
            and st.getQuestItemsCount(LEATHER_POUCH3) == 0
            and st.getQuestItemsCount(LEATHER_POUCH3FULL) == 1
        ):
            ...
            npcId == 30501
            and st.getInt("cond")
            and st.getQuestItemsCount(GANTAKIS_LETTER)
        ):
            ...
            npcId == 30501
            and st.getInt("cond")
            and st.getQuestItemsCount(FIG)
            and (
                st.getQuestItemsCount(LEATHER_PURSE4) == 0
            ...
            npcId == 30501
            and st.getInt("cond")
            and st.getQuestItemsCount(FIG) == 0
            and (
                st.getQuestItemsCount(LEATHER_PURSE4) == 1
                or st.getQuestItemsCount(LEATHER_POUCH4FULL) == 1
            )
        ):
            ...
            npcId == 30501
            and st.getInt("cond")
            and st.getQuestItemsCount(SCROLL_IRON_WILL)
        ):
            ...
            npcId == 30591
            and st.getInt("cond")
            and st.getQuestItemsCount(LEATHER_PURSE4)
            and st.getQuestItemsCount(LEATHER_POUCH4FULL) == 0
        ):
            htmltext = "30591-02.htm"
        elif (
            npcId == 30591
            and st.getInt("cond")
            and st.getQuestItemsCount(LEATHER_PURSE4) == 0
            and st.getQuestItemsCount(LEATHER_POUCH4FULL) == 1
        ):
            ...
            npcId == 30591
            and st.getInt("cond")
            and st.getQuestItemsCount(SCROLL_IRON_WILL) == 1
            and st.getQuestItemsCount(TORUKUS_LETTER) == 1
        ):
        ...
        if npcId == 20479:
            ...
            if st.getInt("cond") and st.getQuestItemsCount(LEATHER_POUCH1) == 1:
                if st.getQuestItemsCount(KASHA_BEAR_CLAW) == 4:
                    st.takeItems(
                        KASHA_BEAR_CLAW, st.getQuestItemsCount(KASHA_BEAR_CLAW)
                    )
            ...
            if st.getInt("cond") and st.getQuestItemsCount(LEATHER_POUCH3) == 1:
                if st.getQuestItemsCount(S_SALAMANDER_SCALE) == 4:
                    st.takeItems(
                        S_SALAMANDER_SCALE, st.getQuestItemsCount(S_SALAMANDER_SCALE)
                    )
            ...
            if st.getInt("cond") and st.getQuestItemsCount(LEATHER_POUCH2) == 1:
                if st.getQuestItemsCount(KASHA_BSPIDER_TALON) == 4:
                    st.takeItems(
                        KASHA_BSPIDER_TALON, st.getQuestItemsCount(KASHA_BSPIDER_TALON)
                    )
            ...
            if (
                st.getInt("cond")
                and st.getQuestItemsCount(LEATHER_PURSE4) == 1
                and st.getQuestItemsCount(VUKU_TUSK) < 3
            ):
                if (
                    st.getQuestItemsCount(RATMAN_FANG)
                    + st.getQuestItemsCount(LANGK_TOOTH)
                    + st.getQuestItemsCount(FELIM_TOOTH)
                    + st.getQuestItemsCount(VUKU_TUSK)
                    >= 11
                ):
            ...
            if (
                st.getInt("cond")
                and st.getQuestItemsCount(LEATHER_PURSE4) == 1
                and st.getQuestItemsCount(RATMAN_FANG) < 3
            ):
                if (
                    st.getQuestItemsCount(RATMAN_FANG)
                    + st.getQuestItemsCount(LANGK_TOOTH)
            ...
            if (
                st.getInt("cond")
                and st.getQuestItemsCount(LEATHER_PURSE4) == 1
                and st.getQuestItemsCount(LANGK_TOOTH) < 3
            ):
                if (
                    st.getQuestItemsCount(RATMAN_FANG)
                    + st.getQuestItemsCount(LANGK_TOOTH)
            ...
            if (
                st.getInt("cond")
                and st.getQuestItemsCount(LEATHER_PURSE4) == 1
                and st.getQuestItemsCount(FELIM_TOOTH) < 3
            ):
                if (
                    st.getQuestItemsCount(RATMAN_FANG)
                    + st.getQuestItemsCount(LANGK_TOOTH)
