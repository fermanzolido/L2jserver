...
(
    ...
    CRETAS_PAINTING2_ID,
    CRETAS_PAINTING3_ID,
    BROWN_SCROLL_SCRAP_ID,
    CRYSTAL_OF_PURITY1_ID,
    HIGHPRIESTS_SIGIL_ID,
    GMAGISTERS_SIGIL_ID,
    CRONOS_SIGIL_ID,
    SYLVAINS_LETTER_ID,
    SYMBOL_OF_SYLVAIN_ID,
    JUREKS_LIST_ID,
    MEYEDESTROYERS_SKIN_ID,
    SHAMANS_NECKLACE_ID,
    SHACKLES_SCALP_ID,
    SYMBOL_OF_JUREK_ID,
    CRONOS_LETTER_ID,
    ...
    TRIFFS_RING_ID,
    SCRIPTURE_CHAPTER_1_ID,
    SCRIPTURE_CHAPTER_2_ID,
    SCRIPTURE_CHAPTER_3_ID,
...
class Quest(JQuest):
    ...
    def onEvent(self, event, st):
        ...
        if event == "1":
            ...
            st.takeItems(
                FETTEREDSOULS_ICHOR_ID, st.getQuestItemsCount(FETTEREDSOULS_ICHOR_ID)
            )
            st.takeItems(
                ENCHT_GARGOYLES_NAIL_ID, st.getQuestItemsCount(ENCHT_GARGOYLES_NAIL_ID)
            )
    ...
    def onTalk(self, npc, player):
        ...
        if npcId == 30461 and cond == 0:
            ...
            npcId == 30461
            and cond == 18
            and st.getQuestItemsCount(MIRIENS_INSTRUCTION_ID) == 1
        ):
            ...
            npcId == 30461
            and cond == 31
            and st.getQuestItemsCount(SYMBOL_OF_CRONOS_ID) == 1
        ):
            ...
            st.getQuestItemsCount(SYMBOL_OF_SYLVAIN_ID)
            or st.getQuestItemsCount(MIRIENS_SIGIL2_ID)
        ):
            htmltext = "30608-16.htm"
        elif (
            npcId == 30608
            and st.getQuestItemsCount(MIRIENS_SIGIL3_ID) == 1
            and st.getQuestItemsCount(VALKONS_REQUEST_ID) == 0
        ):
            htmltext = "30608-17.htm"
        elif (
            npcId == 30608
            and cond == 26
            and st.getQuestItemsCount(VALKONS_REQUEST_ID) == 1
        ):
            ...
            npcId == 30111
            and st.getQuestItemsCount(MIRIENS_SIGIL3_ID)
            and st.getQuestItemsCount(CRONOS_SIGIL_ID)
            and st.getQuestItemsCount(DIETERS_DIARY_ID)
            and st.getQuestItemsCount(RAUTS_LETTER_ENVELOPE_ID)
        ):
            ...
            and st.getQuestItemsCount(CRONOS_SIGIL_ID)
            and st.getQuestItemsCount(DIETERS_DIARY_ID)
            and st.getQuestItemsCount(DIETERS_LETTER_ID) == 0
            and st.getQuestItemsCount(RAUTS_LETTER_ENVELOPE_ID) == 0
        ):
            if (
                st.getQuestItemsCount(SCRIPTURE_CHAPTER_1_ID)
                and st.getQuestItemsCount(SCRIPTURE_CHAPTER_2_ID)
                and st.getQuestItemsCount(SCRIPTURE_CHAPTER_3_ID)
                and st.getQuestItemsCount(SCRIPTURE_CHAPTER_4_ID)
            ):
            ...
            npcId == 30230
            and st.getQuestItemsCount(DIETERS_DIARY_ID) == 1
            and (
                st.getQuestItemsCount(STRONG_LIQUOR_ID)
                or st.getQuestItemsCount(TRIFFS_RING_ID)
            )
        ):
            ...
            npcId == 30316
            and st.getQuestItemsCount(DIETERS_DIARY_ID)
            and st.getQuestItemsCount(SCRIPTURE_CHAPTER_1_ID)
            and st.getQuestItemsCount(TRIFFS_RING_ID)
        ):
            ...
            npcId == 30103
            and cond == 26
            and st.getQuestItemsCount(CRYSTAL_OF_PURITY2_ID) == 1
        ):
            ...
            npcId == 30103
            and cond == 26
            and st.getQuestItemsCount(SCRIPTURE_CHAPTER_2_ID) == 0
        ):
            ...
            npcId == 30458
            and cond == 26
            and st.getQuestItemsCount(POITANS_NOTES_ID) == 0
        ):
            ...
            npcId == 30458
            and cond == 26
            and st.getQuestItemsCount(POITANS_NOTES_ID)
            and st.getQuestItemsCount(CASIANS_LIST_ID) == 0
        ):
            ...
            and cond == 27
            and st.getQuestItemsCount(POITANS_NOTES_ID)
            and st.getQuestItemsCount(CASIANS_LIST_ID)
        ):
            ...
            if (
                st.getQuestItemsCount(GHOULS_SKIN_ID)
                + st.getQuestItemsCount(MEDUSAS_BLOOD_ID)
                + st.getQuestItemsCount(FETTEREDSOULS_ICHOR_ID)
                + st.getQuestItemsCount(ENCHT_GARGOYLES_NAIL_ID)
                < 32
            ):
    ...
    def onKill(self, npc, player, isPet):
        ...
        if npcId == 20580:
            if (
                st.getInt("cond") == 11
                and st.getQuestItemsCount(BROWN_SCROLL_SCRAP_ID) < 5
            ):
        ...
        if st.getInt("cond") == 16:
                ...
                if st.getQuestItemsCount(MEYEDESTROYERS_SKIN_ID) < 5:
                    if st.getRandom(100) < 50:
                        ...
                        if st.getQuestItemsCount(MEYEDESTROYERS_SKIN_ID) < 5:
                            ...
                            st.playSound("ItemSound.quest_middle")
                            if (
                                st.getQuestItemsCount(SHACKLES_SCALP_ID) == 2
                                and st.getQuestItemsCount(SHAMANS_NECKLACE_ID) == 5
                                and st.getQuestItemsCount(MEYEDESTROYERS_SKIN_ID) == 5
                            ):
                                st.set("cond", "17")
            elif npcId == 20269:
            ...
            npcId == 20554
            and st.getInt("cond") in [26, 27]
            and st.getQuestItemsCount(SCRIPTURE_CHAPTER_3_ID) == 0
        ):
            ...
            if st.getInt("cond") == 28 and st.getQuestItemsCount(GHOULS_SKIN_ID) < 10:
                ...
                if st.getQuestItemsCount(GHOULS_SKIN_ID) < 10:
                    ...
                    st.playSound("ItemSound.quest_middle")
                    if (
                        st.getQuestItemsCount(GHOULS_SKIN_ID) == 10
                        and st.getQuestItemsCount(MEDUSAS_BLOOD_ID) == 12
                        and st.getQuestItemsCount(FETTEREDSOULS_ICHOR_ID) == 5
                        and st.getQuestItemsCount(ENCHT_GARGOYLES_NAIL_ID) == 5
                    ):
                        st.set("cond", "29")
        elif npcId == 20158:
