...
class feedable_beasts(JQuest):
    ...
    def __init__(self, id, name, descr):
        ...
        self.growthCapableMobs = {
            ...
            21460: [
                2,
                {GOLDEN_SPICE: [[21468, 21824], [16017, 16018]], CRYSTAL_SPICE: []},
                25,
            ],
            21461: [
                2,
                {GOLDEN_SPICE: [[21469, 21825], [16017, 16018]], CRYSTAL_SPICE: []},
                25,
            ],
            21462: [
                2,
            ...
            21464: [
                2,
                {GOLDEN_SPICE: [], CRYSTAL_SPICE: [[21468, 21824], [16017, 16018]]},
                25,
            ],
            21465: [
                2,
                {GOLDEN_SPICE: [], CRYSTAL_SPICE: [[21469, 21825], [16017, 16018]]},
                25,
            ],
            21466: [
                2,
            ...
            21479: [
                2,
                {GOLDEN_SPICE: [[21487, 21826], [16013, 16014]], CRYSTAL_SPICE: []},
                25,
            ],
            21480: [
                2,
                {GOLDEN_SPICE: [[21488, 21827], [16013, 16014]], CRYSTAL_SPICE: []},
                25,
            ],
            21481: [
                2,
            ...
            21483: [
                2,
                {GOLDEN_SPICE: [], CRYSTAL_SPICE: [[21487, 21826], [16013, 16014]]},
                25,
            ],
            21484: [
                2,
                {GOLDEN_SPICE: [], CRYSTAL_SPICE: [[21488, 21827], [16013, 16014]]},
                25,
            ],
            21485: [
                2,
            ...
            21498: [
                2,
                {GOLDEN_SPICE: [[21506, 21828], [16015, 16016]], CRYSTAL_SPICE: []},
                25,
            ],
            21499: [
                2,
                {GOLDEN_SPICE: [[21507, 21829], [16015, 16016]], CRYSTAL_SPICE: []},
                25,
            ],
            21500: [
                2,
            ...
            21502: [
                2,
                {GOLDEN_SPICE: [], CRYSTAL_SPICE: [[21506, 21828], [16015, 16016]]},
                25,
            ],
            21503: [
                2,
                {GOLDEN_SPICE: [], CRYSTAL_SPICE: [[21507, 21829], [16015, 16016]]},
                25,
            ],
            21504: [
                2,
    ...
    def spawnNext(self, npc, growthLevel, player, food):
        ...
        # all other levels of growth are straight-forward
            ...
            nextNpcId = self.growthCapableMobs[npcId][1][food][
                Rnd.get(len(self.growthCapableMobs[npcId][1][food]))
            ]
    ...
    def onSkillUse(self, npc, player, skill):
        ...
        if npcId not in self.feedableBeasts:
            return
        ...
        if npcId in self.growthCapableMobs.keys():
            ...
            if Rnd.get(20) == 0:
                npc.broadcastPacket(
                    CreatureSay(
                        ...
                        0,
                        npc.getName(),
                        self.Text[growthLevel][Rnd.get(len(self.Text[growthLevel]))],
                    )
                )
            ...
            if growthLevel > 0:
                ...
                if self.feedInfo[objectId] != player.getObjectId():
                    return
            ...
            if skillId == npc.getFoodType():
                ...
                npc.broadcastPacket(
                    CreatureSay(
                        objectId, 0, npc.getName(), mytext[Rnd.get(len(mytext))]
                    )
                )
        return
