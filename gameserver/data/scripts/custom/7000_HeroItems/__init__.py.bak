    ...
    if mode == "list":
        for i in HERO_ITEMS.keys():
            html += (
                ...
                + HERO_ITEMS[i][0]
                + ' width=32 height=32 align=left></td><td valign=top><a action="bypass -h Quest 7000_HeroItems '
                + str(i)
                + '"><font color="FFFFFF">'
                + HERO_ITEMS[i][1]
                + "</font></a></td></tr>"
        ...
        html += (
            '<tr><td align=left><font color="LEVEL">Item Information</font></td><td align=right>\
...
<table border=0><tr><td valign=top width=35><img src=icon.'
            + HERO_ITEMS[item][0]
            + ' width=32 height=32 align=left></td>\
<td valign=top width=400><table border=0 width=100%><tr><td><font color="FFFFFF">'
            + HERO_ITEMS[item][1]
            + '</font></td>\
</tr></table></td></tr></table><br><font color="LEVEL">Item info:</font>\
<table border=0 bgcolor="000000" width=290 height=220><tr><td valign=top><font color="B09878">'
            + HERO_ITEMS[item][2]
            + "</font>\
</td></tr><tr><td><br>Type: "
            + HERO_ITEMS[item][4]
            ...
            + HERO_ITEMS[item][3]
            + '<br><br>\
<table border=0 width=300><tr><td align=center><button value=Obtain action="bypass -h Quest 7000_HeroItems _'
            + str(item)
            + '" width=80 height=27 back=L2UI_ch3.Btn1_normalOn fore=L2UI_ch3.Btn1_normal></td></tr></table></td></tr></table></td></tr>'
        )
